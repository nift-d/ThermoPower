  ...
  package GasTurbine
    ...
    package Interfaces "Interface definitions"
      ...
      partial model GasTurbine "Base class for Gas Turbine"
        ...
        replaceable package FuelMedium = ThermoPower.Media.NaturalGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
        Gas.FlangeA FuelInlet(redeclare package Medium = FuelMedium)
          annotation (Placement(transformation(extent={{-20,180},{20,220}},
                rotation=0)));
        Gas.FlangeA AirInlet(redeclare package Medium = AirMedium) annotation (
            Placement(transformation(extent={{-220,140},{-180,180}}, rotation=0)));
        ...
        ThermoPower.PowerPlants.Buses.Actuators ActuatorsBus annotation (
            Placement(transformation(extent={{220,-180},{180,-140}}, rotation=0)));
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      fillPattern=FillPattern.Sphere,
                      fillColor={170,170,255}),Polygon(
                      points={{-130,112},{-120,106},{-120,166},{-200,166},{-200,
                  154},{-130,154},{-130,112}},
                      lineColor={0,0,0},
                      fillPattern=FillPattern.Sphere,
                      fillColor={170,170,255}),Polygon(
                      points={{130,112},{120,108},{120,166},{200,166},{200,154},
                  {130,154},{130,112}},
                      lineColor={0,0,0},
                      fillPattern=FillPattern.Sphere,
                      fillColor={170,170,255}),Polygon(
                      points={{-130,120},{-30,40},{-30,-40},{-130,-120},{-130,
                  120}},
                      lineColor={0,0,0},
                      fillPattern=FillPattern.Sphere,
                      fillColor={170,170,255}),Polygon(
      ...
      partial model GasTurbineSimplified
        replaceable package FlueGasMedium = ThermoPower.Media.FlueGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
        Gas.FlangeB flueGasOut(redeclare package Medium = FlueGasMedium)
        ...
        annotation (Diagram(graphics), Icon(graphics={Rectangle(
                      ...
                      fillPattern=FillPattern.Sphere,
                      fillColor={170,170,255}),Polygon(
                      points={{80,60},{76,56},{76,82},{100,82},{100,78},{80,78},
                  {80,60}},
                      lineColor={0,0,0},
                      fillPattern=FillPattern.Sphere,
                      fillColor={170,170,255}),Polygon(
  ...
  package HRSG "Models and tests of the HRSG and its main components"
    ...
    package Interfaces "Interface definitions"
      ...
      partial model ParallelHE
        ...
        Water.FlangeA waterInB(redeclare package Medium = FluidMedium)
          "water/steam second inlet" annotation (Placement(transformation(
                extent={{20,80},{60,120}}, rotation=0)));
        Water.FlangeB waterOutB(redeclare package Medium = FluidMedium)
          "water/steam second outlet" annotation (Placement(transformation(
                extent={{20,-120},{60,-80}}, rotation=0)));
        replaceable package FlueGasMedium = ThermoPower.Media.FlueGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
        replaceable package FluidMedium = ThermoPower.Water.StandardWater
          constrainedby Modelica.Media.Interfaces.PartialPureSubstance;
        ...
        parameter Integer N_G=2 "Number of node of the gas side";
        parameter Integer Nw_G=N_G-1 "Number of volumes of the gas side wall";
        parameter Integer N_F_A=2 "Number of node of the fluid side"
          annotation (Dialog(group="side A"));
        parameter Integer Nw_F_A=N_F_A - 1
          "Number of volumes of the fluid side wall"
          annotation (Dialog(group="side A"));
        parameter Integer N_F_B=2 "Number of node of the fluid side"
        ...
        parameter SI.Area extSurfaceTub_B "Total external surface of the tubes"
          annotation (Dialog(group="side B"));
        parameter SI.Volume gasVol "Gas volume";
        parameter SI.Volume fluidVol_A "Fluid volume"
          annotation (Dialog(group="side A"));
        parameter SI.Volume fluidVol_B "Fluid volume"
          annotation (Dialog(group="side B"));
        parameter SI.Volume metalVol_A "Volume of the metal part in the tube"
          annotation (Dialog(group="side A"));
        parameter SI.Volume metalVol_B "Volume of the metal part in the tube"
          annotation (Dialog(group="side B"));
        ...
        annotation (Diagram(graphics), Icon(graphics={Rectangle(
                      ...
                      fillColor={230,230,230},
                      fillPattern=FillPattern.Solid),Line(
                      points={{-40,80},{-40,60},{-10,60},{-10,42},{-42,20},{20,
                  -20},{-10,-40},{-10,-60},{-40,-60},{-40,-80}},
                      color={0,0,255},
                      thickness=0.5),Line(
                      points={{40,80},{40,60},{10,60},{10,40},{-20,20},{42,-20},
      ...
      partial model ParallelHE_Des
        ...
        Water.FlangeB waterOutB(redeclare package Medium = FluidMedium)
          "water/steam second outlet" annotation (Placement(transformation(
                extent={{20,-120},{60,-80}}, rotation=0)));
        Water.FlangeA LiquidWaterIn_A(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-110,-52},{-90,-32}},
                rotation=0)));
        Modelica.Blocks.Interfaces.RealOutput T_intermedA
          "Intermediate temperature of the HE_A" annotation (Placement(
              transformation(extent={{94,52},{108,66}}, rotation=0)));
        Modelica.Blocks.Interfaces.RealOutput T_intermedB
          "Intermediate temperature of the HE_B" annotation (Placement(
              transformation(extent={{94,32},{108,46}}, rotation=0)));
        Modelica.Blocks.Interfaces.RealInput theta_valveA annotation (Placement(
              transformation(extent={{108,-50},{94,-34}}, rotation=0)));
        Modelica.Blocks.Interfaces.RealInput theta_valveB annotation (Placement(
              transformation(extent={{108,-70},{94,-56}}, rotation=0)));
        replaceable package FlueGasMedium = ThermoPower.Media.FlueGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
        replaceable package FluidMedium = ThermoPower.Water.StandardWater
          constrainedby Modelica.Media.Interfaces.PartialPureSubstance;
        ...
        parameter Integer Nw_G_p1=N_G_p1 - 1
          "Number of volumes of the gas side wall"
          annotation (Dialog(tab="pHE-1"));
        parameter Integer N_F_A_p1=2 "Number of node of the fluid side"
          annotation (Dialog(tab="pHE-1", group="side A"));
        parameter Integer Nw_F_A_p1=N_F_A_p1 - 1
          "Number of volumes of the fluid side wall"
          annotation (Dialog(tab="pHE-1"));
        parameter Integer N_F_B_p1=2 "Number of node of the fluid side"
        ...
        parameter SI.Area extSurfaceTub_B_p1
          "Total external surface of the tubes"
          annotation (Dialog(tab="pHE-1", group="side B"));
        parameter SI.Volume gasVol_p1 "Gas volume"
          annotation (Dialog(tab="pHE-1"));
        parameter SI.Volume fluidVol_A_p1 "Fluid volume"
          annotation (Dialog(tab="pHE-1", group="side A"));
        parameter SI.Volume fluidVol_B_p1 "Fluid volume"
          annotation (Dialog(tab="pHE-1", group="side B"));
        ...
        parameter Integer Nw_G_p2=N_G_p2 - 1
          "Number of volumes of the gas side wall"
          annotation (Dialog(tab="pHE-2"));
        parameter Integer N_F_A_p2=2 "Number of node of the fluid side"
          annotation (Dialog(tab="pHE-2", group="side A"));
        parameter Integer Nw_F_A_p2=N_F_A_p2 - 1
          "Number of volumes of the fluid side wall"
          annotation (Dialog(tab="pHE-2"));
        parameter Integer N_F_B_p2=2 "Number of node of the fluid side"
        ...
        parameter SI.Area extSurfaceTub_B_p2
          "Total external surface of the tubes"
          annotation (Dialog(tab="pHE-2", group="side B"));
        parameter SI.Volume gasVol_p2 "Gas volume"
          annotation (Dialog(tab="pHE-2"));
        parameter SI.Volume fluidVol_A_p2 "Fluid volume"
          annotation (Dialog(tab="pHE-2", group="side A"));
        parameter SI.Volume fluidVol_B_p2 "Fluid volume"
          annotation (Dialog(tab="pHE-2", group="side B"));
        ...
        Water.FlangeA LiquidWaterIn_B(redeclare package Medium = FluidMedium)
        ...
        annotation (Diagram(graphics), Icon(graphics={Rectangle(
                  ...
                  {10,-40},{10,-60},{40,-60},{40,-80}},
                      ...
                      lineThickness=0.5,
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-48,-50},{-68,
                -70},{-96,-70},{-98,-70}}, color={0,0,255}),Line(points={{-62,-36},
                {-68,-42},{-100,-42},{-102,-42}}, color={0,0,255})}));
      end ParallelHE_Des;
      ...
      partial model HEG_2L
        ...
        parameter SI.Area Sh2_HP_exchSurface_G
          "Exchange surface between gas - metal tube, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Area Sh2_HP_exchSurface_F
          "Exchange surface between metal tube - fluid, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Area Sh2_HP_extSurfaceTub
          "Total external surface of the tubes, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Volume Sh2_HP_gasVol "Gas volume, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Volume Sh2_HP_fluidVol "Fluid volume, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        ...
        parameter SI.Area Sh1_HP_exchSurface_G
          "Exchange surface between gas - metal tube, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Area Sh1_HP_exchSurface_F
          "Exchange surface between metal tube - fluid, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Area Sh1_HP_extSurfaceTub
          "Total external surface of the tubes, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Volume Sh1_HP_gasVol "Gas volume, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Volume Sh1_HP_fluidVol "Fluid volume, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        ...
        parameter SI.Area Ev_HP_extSurfaceTub
          "Total external surface of the tubes"
          annotation (Dialog(tab="HP", group="Ev"));
        parameter SI.Volume Ev_HP_gasVol "Gas volume"
          annotation (Dialog(tab="HP", group="Ev"));
        parameter SI.Volume Ev_HP_fluidVol "Fluid volume"
          annotation (Dialog(tab="HP", group="Ev"));
        ...
        parameter SI.Area Ec_HP_extSurfaceTub
          "Total external surface of the tubes"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Volume Ec_HP_gasVol "Gas volume"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Volume Ec_HP_fluidVol "Fluid volume"
          annotation (Dialog(tab="HP", group="Ec"));
        ...
        parameter SI.Area Sh_LP_extSurfaceTub
          "Total external surface of the tubes"
          annotation (Dialog(tab="LP", group="Sh"));
        parameter SI.Volume Sh_LP_gasVol "Gas volume"
          annotation (Dialog(tab="LP", group="Sh"));
        parameter SI.Volume Sh_LP_fluidVol "Fluid volume"
          annotation (Dialog(tab="LP", group="Sh"));
        ...
        parameter SI.Area Ev_LP_extSurfaceTub
          "Total external surface of the tubes"
          annotation (Dialog(tab="LP", group="Ev"));
        parameter SI.Volume Ev_LP_gasVol "Gas volume"
          annotation (Dialog(tab="LP", group="Ev"));
        parameter SI.Volume Ev_LP_fluidVol "Fluid volume"
          annotation (Dialog(tab="LP", group="Ev"));
        ...
        parameter SI.Area Ec_LP_extSurfaceTub
          "Total external surface of the tubes"
          annotation (Dialog(tab="LP", group="Ec"));
        parameter SI.Volume Ec_LP_gasVol "Gas volume"
          annotation (Dialog(tab="LP", group="Ec"));
        parameter SI.Volume Ec_LP_fluidVol "Fluid volume"
          annotation (Dialog(tab="LP", group="Ec"));
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={170,170,255},
                      fillColor={230,230,230},
                      fillPattern=FillPattern.Solid),Line(points={{-120,200},{-120,
                -100}}, color={0,0,255}),Line(points={{-160,-100},{-156,-110},{
                -144,-120},{-136,-120},{-124,-110},{-120,-100}}, color={0,0,255}),
                Line(points={{-160,200},{-160,-100}}, color={0,0,255}),Line(
                points={{-200,200},{-200,-102}}, color={0,0,255}),Line(points={
                {-240,-100},{-236,-110},{-224,-120},{-216,-120},{-204,-110},{-200,
                -100}}, color={0,0,255}),Line(points={{-240,200},{-240,-100}},
                color={0,0,255}),Line(points={{-200,-200},{-200,-140},{-280,-140},
                {-280,204},{-278,200}}, color={0,0,255}),Line(
                      ...
                      color={170,170,255},
                      pattern=LinePattern.Dash,
                      thickness=0.5),Line(points={{140,-200},{140,-140},{60,-140},
                {60,204},{62,200}}, color={0,0,255}),Line(points={{100,-100},{
                104,-110},{116,-120},{124,-120},{136,-110},{140,-100}}, color={
                0,0,255}),Line(points={{100,200},{100,-102}}, color={0,0,255}),
                Line(points={{140,200},{140,-102}}, color={0,0,255}),Line(
                points={{180,200},{180,-102}}, color={0,0,255}),Line(points={{
                220,200},{220,-102}}, color={0,0,255}),Line(points={{180,-100},
                {184,-110},{196,-120},{204,-120},{216,-110},{220,-100}}, color=
      ...
      partial model HEG_2LRh
        ...
        parameter SI.Area Rh2_IP_exchSurface_G
          "Exchange surface between gas - metal tube, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Area Rh2_IP_exchSurface_F
          "Exchange surface between metal tube - fluid, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Area Rh2_IP_extSurfaceTub
          "Total external surface of the tubes, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Volume Rh2_IP_gasVol "Gas volume, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Volume Rh2_IP_fluidVol "Fluid volume, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        ...
        parameter SI.Area Rh1_IP_exchSurface_G
          "Exchange surface between gas - metal tube, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Area Rh1_IP_exchSurface_F
          "Exchange surface between metal tube - fluid, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Area Rh1_IP_extSurfaceTub
          "Total external surface of the tubes, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Volume Rh1_IP_gasVol "Gas volume, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Volume Rh1_IP_fluidVol "Fluid volume, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                ...
                -144,-120},{-136,-120},{-124,-110},{-120,-100}}, color={0,0,255}),
                Line(points={{-160,200},{-160,-100}}, color={0,0,255}),Line(
                points={{-200,200},{-200,-100}}, color={0,0,255}),Line(points={
                {-240,-100},{-236,-110},{-224,-120},{-216,-120},{-204,-110},{-200,
                -100}}, color={0,0,255}),Line(points={{-240,200},{-240,-100}},
                color={0,0,255}),Line(points={{-200,-200},{-200,-140},{-280,-140},
                {-280,204},{-278,200}}, color={0,0,255}),Line(
                      ...
                      color={170,170,255},
                      pattern=LinePattern.Dash,
                      thickness=0.5),Line(points={{-60,100},{-50,114},{-34,120},
                {-26,120},{-10,114},{0,100}}, color={0,0,255}),Line(points={{-60,
                100},{-60,-198}}, color={0,0,255}),Line(points={{0,100},{0,-198}},
                color={0,0,255}),Line(points={{140,-200},{140,-140},{60,-140},{
                60,204},{62,200}}, color={0,0,255}),Line(points={{100,-100},{
                104,-110},{116,-120},{124,-120},{136,-110},{140,-100}}, color={
                0,0,255}),Line(points={{100,200},{100,-100}}, color={0,0,255}),
                Line(points={{140,200},{140,-100}}, color={0,0,255}),Line(
                points={{180,202},{180,-100}}, color={0,0,255}),Line(points={{
                220,202},{220,-100}}, color={0,0,255}),Line(points={{180,-100},
                {184,-110},{196,-120},{204,-120},{216,-110},{220,-100}}, color=
                ...
                255}),Polygon(points={{94,144},{106,144},{100,160},{94,144}},
                lineColor={0,0,255}),Polygon(points={{134,138},{146,138},{140,
                122},{134,138}}, lineColor={0,0,255}),Polygon(points={{174,144},
                {186,144},{180,160},{174,144}}, lineColor={0,0,255}),Polygon(
                points={{214,138},{226,138},{220,122},{214,138}}, lineColor={0,
                0,255}),Polygon(points={{-66,-142},{-54,-142},{-60,-158},{-66,-142}},
                lineColor={0,0,255}),Polygon(points={{-6,-136},{6,-136},{0,-120},
                {-6,-136}}, lineColor={0,0,255}),Text(
                      extent={{-78,-132},{22,-152}},
                      lineColor={0,0,255},
                      lineThickness=0.5,
                      textString="Rh")}), Diagram(coordinateSystem(
              preserveAspectRatio=true,
              extent={{-400,-200},{400,200}},
              initialScale=0.1), graphics));
      end HEG_2LRh;
      ...
      partial model HEG_3LRh
        ...
        Water.FlangeB Sh_LP_Out(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{286,-212},{314,-184}},
                rotation=0)));
        Buses.Sensors SensorsBus annotation (Placement(transformation(extent={{
                  480,120},{520,160}}, rotation=0)));
        Buses.Actuators ActuatorsBus annotation (Placement(transformation(
                extent={{520,60},{480,100}}, rotation=0)));
        replaceable package FlueGasMedium = ThermoPower.Media.FlueGas
          constrainedby Modelica.Media.Interfaces.PartialMedium;
        replaceable package FluidMedium = ThermoPower.Water.StandardWater
          constrainedby Modelica.Media.Interfaces.PartialPureSubstance;
        ...
        parameter Integer Sh2_HP_Nw_G=Sh2_HP_N_G - 1
          "Number of node of the gas side, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter Integer Sh2_HP_N_F=2 "Number of node of the fluid side, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter Integer Sh2_HP_Nw_F=Sh2_HP_N_F - 1
          "Number of node of the fluid side, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Area Sh2_HP_exchSurface_G
          "Exchange surface between gas - metal tube, Sh2"
          annotation (Dialog(tab="HP", group="Sh"));
        ...
        parameter Integer Sh1_HP_Nw_G=Sh1_HP_N_G - 1
          "Number of node of the gas side, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter Integer Sh1_HP_N_F=2 "Number of node of the fluid side, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter Integer Sh1_HP_Nw_F=Sh1_HP_N_F - 1
          "Number of node of the fluid side, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        parameter SI.Area Sh1_HP_exchSurface_G
          "Exchange surface between gas - metal tube, Sh1"
          annotation (Dialog(tab="HP", group="Sh"));
        ...
        parameter Integer Ev_HP_Nw_G=Ev_HP_N_G - 1
          "Number of node of the gas side"
          annotation (Dialog(tab="HP", group="Ev"));
        parameter Integer Ev_HP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="HP", group="Ev"));
        parameter Integer Ev_HP_Nw_F=Ev_HP_N_F -1
          "Number of node of the fluid side"
          annotation (Dialog(tab="HP", group="Ev"));
        parameter SI.Area Ev_HP_exchSurface_G
          "Exchange surface between gas - metal tube"
          annotation (Dialog(tab="HP", group="Ev"));
        ...
        parameter Integer Ec2_HP_Nw_G=Ec2_HP_N_G - 1
          "Number of node of the gas side, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter Integer Ec2_HP_N_F=2 "Number of node of the fluid side, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter Integer Ec2_HP_Nw_F=Ec2_HP_N_F - 1
          "Number of node of the fluid side, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Area Ec2_HP_exchSurface_G
          "Exchange surface between gas - metal tube, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Area Ec2_HP_exchSurface_F
          "Exchange surface between metal tube - fluid, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Area Ec2_HP_extSurfaceTub
          "Total external surface of the tubes, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Volume Ec2_HP_gasVol "Gas volume, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Volume Ec2_HP_fluidVol "Fluid volume, Ec2"
          annotation (Dialog(tab="HP", group="Ec"));
        ...
        parameter Integer Ec1_HP_Nw_G=Ec1_HP_N_G - 1
          "Number of node of the gas side, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter Integer Ec1_HP_N_F=2 "Number of node of the fluid side, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter Integer Ec1_HP_Nw_F=Ec1_HP_N_F - 1
          "Number of node of the fluid side, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Area Ec1_HP_exchSurface_G
          "Exchange surface between gas - metal tube, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Area Ec1_HP_exchSurface_F
          "Exchange surface between metal tube - fluid, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Area Ec1_HP_extSurfaceTub
          "Total external surface of the tubes, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Volume Ec1_HP_gasVol "Gas volume, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        parameter SI.Volume Ec1_HP_fluidVol "Fluid volume, Ec1"
          annotation (Dialog(tab="HP", group="Ec"));
        ...
        parameter Integer Rh2_IP_Nw_G=Rh2_IP_N_G - 1
          "Number of node of the gas side, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter Integer Rh2_IP_N_F=2 "Number of node of the fluid side, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter Integer Rh2_IP_Nw_F=Rh2_IP_N_F - 1
          "Number of node of the fluid side, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Area Rh2_IP_exchSurface_G
          "Exchange surface between gas - metal tube, Rh2"
          annotation (Dialog(tab="IP", group="Rh"));
        ...
        parameter Integer Rh1_IP_Nw_G=Rh1_IP_N_G - 1
          "Number of node of the gas side, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter Integer Rh1_IP_N_F=2 "Number of node of the fluid side, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter Integer Rh1_IP_Nw_F=Rh1_IP_N_F - 1
          "Number of node of the fluid side, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        parameter SI.Area Rh1_IP_exchSurface_G
          "Exchange surface between gas - metal tube, Rh1"
          annotation (Dialog(tab="IP", group="Rh"));
        ...
        parameter Integer Sh_IP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="IP", group="Sh"));
        parameter Integer Sh_IP_Nw_F=Sh_IP_N_F - 1
          "Number of node of the fluid side"
          annotation (Dialog(tab="IP", group="Sh"));
        ...
        parameter SI.Area Sh_IP_extSurfaceTub
          "Total external surface of the tube"
          annotation (Dialog(tab="IP", group="Sh"));
        parameter SI.Volume Sh_IP_gasVol "Gas volume"
          annotation (Dialog(tab="IP", group="Sh"));
        parameter SI.Volume Sh_IP_fluidVol "Fluid volume"
          annotation (Dialog(tab="IP", group="Sh"));
        ...
        parameter Integer Ev_IP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="IP", group="Ev"));
        parameter Integer Ev_IP_Nw_F=Ev_IP_N_F - 1
          "Number of node of the fluid side"
          annotation (Dialog(tab="IP", group="Ev"));
        ...
        parameter SI.Area Ev_IP_extSurfaceTub
          "Total external surface of the tubes"
          annotation (Dialog(tab="IP", group="Ev"));
        parameter SI.Volume Ev_IP_gasVol "Gas volume"
          annotation (Dialog(tab="IP", group="Ev"));
        parameter SI.Volume Ev_IP_fluidVol "Fluid volume"
          annotation (Dialog(tab="IP", group="Ev"));
        ...
        parameter Integer Ec_IP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="IP", group="Ec"));
        parameter Integer Ec_IP_Nw_F=Ec_IP_N_F - 1
          "Number of node of the fluid side"
          annotation (Dialog(tab="IP", group="Ec"));
        ...
        parameter SI.Area Ec_IP_extSurfaceTub
          "Total external surface of the tube"
          annotation (Dialog(tab="IP", group="Ec"));
        parameter SI.Volume Ec_IP_gasVol "Gas volume"
          annotation (Dialog(tab="IP", group="Ec"));
        parameter SI.Volume Ec_IP_fluidVol "Fluid volume"
          annotation (Dialog(tab="IP", group="Ec"));
        ...
        parameter Integer Sh_LP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="LP", group="Sh"));
        parameter Integer Sh_LP_Nw_F=Sh_LP_N_F - 1
          "Number of node of the fluid side"
          annotation (Dialog(tab="LP", group="Sh"));
        parameter SI.Area Sh_LP_exchSurface_G
          "Exchange surface between gas - metal tube"
        ...
        parameter Integer Ev_LP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="LP", group="Ev"));
        parameter Integer Ev_LP_Nw_F=Ev_LP_N_F - 1
          "Number of node of the fluid side"
          annotation (Dialog(tab="LP", group="Ev"));
        parameter SI.Area Ev_LP_exchSurface_G
          "Exchange surface between gas - metal tube"
        ...
        parameter Integer Ec_LP_N_F=2 "Number of node of the fluid side"
          annotation (Dialog(tab="LP", group="Ec"));
        parameter Integer Ec_LP_Nw_F=Ec_LP_N_F - 1
          "Number of node of the fluid side"
          annotation (Dialog(tab="LP", group="Ec"));
        parameter SI.Area Ec_LP_exchSurface_G
          "Exchange surface between gas - metal tube"
      ...
      partial model DG_2L "Base class for Drums Group with two pressure levels"
        ...
        parameter SI.Length HPd_rint "Internal radius"
          annotation (Dialog(group="HP drum"));
        parameter SI.Length HPd_rext "External radius"
          annotation (Dialog(group="HP drum"));
        ...
        parameter SI.Length LPd_rint "Internal radius"
          annotation (Dialog(group="LP drum"));
        parameter SI.Length LPd_rext "External radius"
          annotation (Dialog(group="LP drum"));
        ...
        Water.FlangeA Feed_LP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{166,-314},{194,-286}},
                rotation=0)));
        Buses.Sensors SensorsBus annotation (Placement(transformation(extent={{
                  380,60},{420,100}}, rotation=0)));
        Buses.Actuators ActuatorsBus annotation (Placement(transformation(
                extent={{420,0},{380,40}}, rotation=0)));
        annotation (Icon(coordinateSystem(
              preserveAspectRatio=false,
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={170,170,255},
                      fillColor={230,230,230},
                      fillPattern=FillPattern.Solid),Line(points={{140,10},{-120,
                10},{-120,-300}}, color={0,0,255}),Ellipse(
                      extent={{80,80},{180,-20}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{180,-300},{
                180,-20},{140,30}}, color={0,0,255}),Line(points={{140,-300},{
                140,72}}, color={0,0,255}),Line(points={{100,-296},{100,-6}},
                color={0,0,255}),Line(points={{60,-296},{60,-50},{60,-10},{60,
                80},{80,80},{130,30},{130,30}}, color={0,0,255}),Polygon(
                      points={{80,30},{180,30},{180,38},{178,48},{172,58},{166,
                  66},{158,72},{148,78},{138,80},{130,80},{122,80},{112,78},{
                  102,72},{94,66},{88,58},{82,48},{80,38},{80,38},{80,30}},
                      lineColor={0,0,255},
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-160,-290},{
                -160,-20},{-200,30}}, color={0,0,255}),Line(points={{-200,-300},
                {-200,-2}}, color={0,0,255}),Line(points={{-240,-298},{-240,-6}},
                color={0,0,255}),Line(points={{-280,-298},{-280,-50},{-280,-10},
                {-280,80},{-260,80},{-210,30},{-210,30}}, color={0,0,255}),
                Polygon(
                      points={{-260,30},{-160,30},{-160,38},{-162,48},{-168,58},
                  {-174,66},{-182,72},{-192,78},{-202,80},{-210,80},{-218,80},{
                  -228,78},{-238,72},{-246,66},{-252,58},{-258,48},{-260,38},{-260,
                  38},{-260,30}},
                      lineColor={0,0,255},
                      fillColor={170,213,255},
                      fillPattern=FillPattern.Solid),Ellipse(
                      ...
                      fillPattern=FillPattern.Solid),Line(points={{-20,10},{-60,
                10},{-30,28},{-60,10},{-32,-8}}, color={0,0,255}),Polygon(
                points={{-286,-204},{-274,-204},{-280,-220},{-286,-204}},
                lineColor={0,0,255}),Polygon(points={{-246,-198},{-234,-198},{-240,
                -182},{-246,-198}}, lineColor={0,0,255}),Polygon(points={{-206,
                -204},{-194,-204},{-200,-220},{-206,-204}}, lineColor={0,0,255}),
                Polygon(points={{-166,-198},{-154,-198},{-160,-182},{-166,-198}},
                lineColor={0,0,255}),Polygon(points={{-126,-204},{-114,-204},{-120,
                -220},{-126,-204}}, lineColor={0,0,255}),Polygon(points={{54,-204},
                {66,-204},{60,-220},{54,-204}}, lineColor={0,0,255}),Polygon(
                points={{94,-198},{106,-198},{100,-182},{94,-198}}, lineColor={
                0,0,255}),Polygon(points={{134,-204},{146,-204},{140,-220},{134,
                -204}}, lineColor={0,0,255}),Polygon(points={{174,-198},{186,-198},
                {180,-182},{174,-198}}, lineColor={0,0,255})}), Diagram(
              coordinateSystem(
              preserveAspectRatio=true,
              extent={{-400,-300},{400,300}},
              initialScale=0.1), graphics));
      ...
      partial model DG_3L_s
        ...
        parameter SI.Length IPd_rint "Internal radius"
          annotation (Dialog(group="IP drum"));
        parameter SI.Length IPd_rext "External radius"
          annotation (Dialog(group="IP drum"));
        ...
        Water.FlangeA Feed_LP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{326,-314},{354,-286}},
                rotation=0)));
        Buses.Sensors SensorsBus annotation (Placement(transformation(extent={{
                  480,60},{520,100}}, rotation=0)));
        Buses.Actuators ActuatorsBus annotation (Placement(transformation(
                extent={{520,0},{480,40}}, rotation=0)));
        annotation (Icon(coordinateSystem(
              preserveAspectRatio=true,
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{340,-302},{
                340,-20},{300,30}}, color={0,0,255}),Line(points={{300,-300},{
                300,-2}}, color={0,0,255}),Line(points={{260,-300},{260,-6}},
                color={0,0,255}),Line(points={{220,-300},{220,-50},{220,-10},{
                220,80},{240,80},{290,30},{290,30}}, color={0,0,255}),Polygon(
                      points={{240,30},{340,30},{340,38},{338,48},{332,58},{326,
                  66},{318,72},{308,78},{298,80},{290,80},{282,80},{272,78},{
                  262,72},{254,66},{248,58},{242,48},{240,38},{240,38},{240,30}},
                      lineColor={0,0,255},
                      fillColor={170,213,255},
                      fillPattern=FillPattern.Solid),Line(points={{300,8},{80,8},
                {80,-300}}, color={0,0,255}),Line(points={{80,-120},{-220,-120},
                {-220,-302}}, color={0,0,255}),Ellipse(
                      extent={{-60,80},{40,-20}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{40,-300},{40,
                -20},{0,30}}, color={0,0,255}),Line(points={{0,-300},{0,72}},
                color={0,0,255}),Line(points={{-40,-296},{-40,-6}}, color={0,0,
                255}),Line(points={{-80,-296},{-80,-50},{-80,-10},{-80,80},{-60,
                80},{-10,30},{-10,30}}, color={0,0,255}),Polygon(
                      points={{-60,30},{40,30},{40,38},{38,48},{32,58},{26,66},
                  {18,72},{8,78},{-2,80},{-10,80},{-18,80},{-28,78},{-38,72},{-46,
                  66},{-52,58},{-58,48},{-60,38},{-60,38},{-60,30}},
                      lineColor={0,0,255},
                      fillColor={170,213,255},
                      fillPattern=FillPattern.Solid),Ellipse(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-260,-290},{
                -260,-20},{-300,30}}, color={0,0,255}),Line(points={{-300,-300},
                {-300,-2}}, color={0,0,255}),Line(points={{-340,-298},{-340,-6}},
                color={0,0,255}),Line(points={{-380,-298},{-380,-50},{-380,-10},
                {-380,80},{-360,80},{-310,30},{-310,30}}, color={0,0,255}),
                Polygon(
                      points={{-360,30},{-260,30},{-260,38},{-262,48},{-268,58},
                  {-274,66},{-282,72},{-292,78},{-302,80},{-310,80},{-318,80},{
                  -328,78},{-338,72},{-346,66},{-352,58},{-358,48},{-360,38},{-360,
                  38},{-360,30}},
                      lineColor={0,0,255},
                      fillColor={170,213,255},
                      fillPattern=FillPattern.Solid),Ellipse(
                      ...
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{172,8},{132,
                8},{162,26},{132,8},{160,-10}}, color={0,0,255}),Ellipse(
                      extent={{-180,-100},{-140,-140}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{-140,-120},{
                -180,-120},{-150,-102},{-180,-120},{-152,-138}}, color={0,0,255}),
                Polygon(points={{-386,-234},{-374,-234},{-380,-250},{-386,-234}},
                lineColor={0,0,255}),Polygon(points={{-346,-228},{-334,-228},{-340,
                -212},{-346,-228}}, lineColor={0,0,255}),Polygon(points={{-306,
                -234},{-294,-234},{-300,-250},{-306,-234}}, lineColor={0,0,255}),
                ...
                {346,-228},{340,-212},{334,-228}}, lineColor={0,0,255}),Ellipse(
                      extent={{76,-116},{84,-124}},
                      lineColor={0,0,255},
                      lineThickness=0.5,
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Polygon(points={{74,-60},{
                86,-60},{80,-76},{74,-60}}, lineColor={0,0,255})}), Diagram(
              coordinateSystem(
              preserveAspectRatio=true,
              extent={{-500,-300},{500,300}},
              initialScale=0.1), graphics));
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                ...
                {-220,-302}}, color={0,0,255}),Ellipse(
                      ...
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{-220,-160},{
                -220,-200},{-238,-172},{-220,-200},{-202,-172}}, color={0,0,255}),
                Ellipse(
                      extent={{60,-160},{100,-200}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{80,-160},{80,
                -200},{62,-172},{80,-200},{98,-172}}, color={0,0,255}),Polygon(
                points={{-386,-234},{-374,-234},{-380,-250},{-386,-234}},
                lineColor={0,0,255}),Polygon(points={{-346,-228},{-334,-228},{-340,
                -212},{-346,-228}}, lineColor={0,0,255}),Polygon(points={{-306,
                -234},{-294,-234},{-300,-250},{-306,-234}}, lineColor={0,0,255}),
                Polygon(points={{-266,-228},{-254,-228},{-260,-212},{-266,-228}},
                ...
                lineColor={0,0,255}),Polygon(points={{294,-234},{306,-234},{300,
                -250},{294,-234}}, lineColor={0,0,255}),Polygon(points={{334,-228},
                {346,-228},{340,-212},{334,-228}}, lineColor={0,0,255}),Polygon(
                points={{74,-52},{86,-52},{80,-68},{74,-52}}, lineColor={0,0,
                255})}), Diagram(coordinateSystem(
              preserveAspectRatio=true,
              extent={{-500,-300},{500,300}},
              initialScale=0.1), graphics));
      ...
      partial model HRSG_2L
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Polygon(
                      points={{-130,130},{-70,130},{-70,134},{-70,134},{-72,142},
                  {-74,146},{-78,152},{-84,156},{-88,158},{-96,160},{-100,160},
                  ...
                  142},{-130,134},{-130,130}},
                      ...
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Polygon(
                      points={{70,130},{130,130},{130,134},{130,134},{128,142},
                  {126,146},{122,152},{116,156},{112,158},{104,160},{100,160},{
                  96,160},{88,158},{84,156},{78,152},{74,146},{72,142},{70,134},
                  {70,130}},
                      lineColor={0,0,255},
                      fillColor={170,213,255},
                      fillPattern=FillPattern.Solid),Rectangle(
                      ...
                      fillPattern=FillPattern.Solid),Line(
                      points={{-100,60},{-100,20},{-60,0},{-140,-40},{-60,-80},
                  {-100,-100},{-100,-140}},
                      color={0,0,255},
                      thickness=0.5),Line(
                      points={{100,60},{100,20},{140,0},{60,-40},{140,-80},{100,
                  -100},{100,-140}},
                      color={0,0,255},
    ...
    package Components "HRSG component models"
      ...
      model HE "Heat Exchanger fluid - gas"
        ...
        replaceable model HeatExchangerTopology =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        ...
        Thermal.HeatExchangerTopologyFV heatExchangerTopology(
          Nw=Nw_F, redeclare model HeatExchangerTopology =
              HeatExchangerTopology)                                              annotation (Placement(transformation(extent={{-10,6},{10,26}})));
      equation
      ...
      model HE2ph "Heat Exchanger fluid - gas (2phases)"
        ...
        Water.Flow1DFV2ph fluidFlow(
          ...
          FluidPhaseStart=FluidPhaseStart,
          pstart=pstart_F,
          redeclare model HeatTransfer = HeatTransfer_F) annotation (Placement(transformation(extent={{-10,-60},
                  {10,-40}}, rotation=0)));
        ...
        Gas.Flow1DFV gasFlow(
          ...
          Cfnom=Cfnom_G,
          Tstartbar=Tstartbar_G,
          redeclare model HeatTransfer = HeatTransfer_G) annotation (Placement(transformation(extent={{
                  -12,58},{12,38}}, rotation=0)));

        Thermal.HeatExchangerTopologyFV heatExchangerTopology(
          Nw=Nw_F, redeclare model HeatExchangerTopology =
              HeatExchangerTopology)                                              annotation (Placement(transformation(extent={{-10,4},{10,24}})));
      ...
      equation
        ...
        connect(fluidFlow.infl, waterIn) annotation (Line(
            ...
            thickness=0.5,
            color={0,0,255}));
        connect(metalTube.int, fluidFlow.wall) annotation (Line(
            points={{0,-19},{0,-45}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(heatExchangerTopology.side2, metalTube.ext) annotation (Line(
            points={{0,10.9},{0,-12.9}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(heatExchangerTopology.side1, gasFlow.wall) annotation (Line(
            points={{0,17},{0,43}},
      ...
      model ParHE "Parallel heat exchangers fluid - gas"
        ...
        replaceable model HeatTransfer_FA =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);

        replaceable model HeatTransfer_FB =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);

        replaceable model HeatTransfer_GA =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);

        replaceable model HeatTransfer_GB =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);

        replaceable model HeatExchangerTopology_A =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        constrainedby ThermoPower.Thermal.BaseClasses.HeatExchangerTopologyData
        annotation(choicesAllMatching=true);

        replaceable model HeatExchangerTopology_B =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        constrainedby ThermoPower.Thermal.BaseClasses.HeatExchangerTopologyData
        annotation(choicesAllMatching=true);
        ...
        Water.Flow1DFV fluidAFlow(
          ...
          pstart=pstart_F_A,
          redeclare model HeatTransfer=HeatTransfer_FA) annotation (Placement(transformation(extent={{-38,
                  -56},{-18,-36}}, rotation=0)));
        ...
        Thermal.MetalTubeFV metalTube_A(
          ...
          rhomcm=rhomcm_A,
          Tstartbar=Tstartbar_M_A) annotation (Placement(transformation(extent={{-38,-10},
                  {-18,-30}},           rotation=0)));

        Gas.Flow1DFV2w gasFlow(
          Nt=1,
          N=N_G,
          Nw=Nw_G,
          Dhyd=1,
          ...
          Cfnom=Cfnom_G,
          Tstartbar=Tstartbar_G,
          redeclare model HeatTransfer = HeatTransfer_GA,
          redeclare model HeatTransfer2 = HeatTransfer_GB) annotation (Placement(transformation(extent={{-8,42},
                  {16,22}},         rotation=0)));

        Water.Flow1DFV fluidBFlow(
          Nt=1,
          N=N_F_B,
          Nw=Nw_F_B,
          initOpt=if SSInit then Options.steadyState else Options.noInit,
          ...
          pstart=pstart_F_B,
          redeclare model HeatTransfer = HeatTransfer_FB) annotation (Placement(transformation(extent={{38,-56},
                  {18,-36}}, rotation=0)));
        ...
        Thermal.MetalTubeFV metalTube_B(
          ...
          rhomcm=rhomcm_B,
          Tstartbar=Tstartbar_M_B) annotation (Placement(transformation(extent={{18,-10},
                  {38,-30}},          rotation=0)));

        Thermal.HeatExchangerTopologyFV heatExchangerTopology_A(
          Nw=Nw_F_A, redeclare model HeatExchangerTopology =
              HeatExchangerTopology_A)                                                   annotation (Placement(transformation(extent={{-38,-4},{-18,16}})));

        Thermal.HeatExchangerTopologyFV heatExchangerTopology_B(
          Nw=Nw_F_B, redeclare model HeatExchangerTopology =
              HeatExchangerTopology_B)                                                   annotation (Placement(transformation(extent={{18,-4},{38,16}})));
      equation
        connect(fluidBFlow.outfl, waterOutB) annotation (Line(
            points={{18,-46},{8,-46},{8,-100},{40,-100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidAFlow.outfl, waterOutA) annotation (Line(
            points={{-18,-46},{-8,-46},{-8,-100},{-40,-100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidAFlow.infl, waterInA) annotation (Line(
            points={{-38,-46},{-50,-46},{-50,100},{-40,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidBFlow.infl, waterInB) annotation (Line(
            points={{38,-46},{52,-46},{52,100},{40,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(gasFlow.outfl, gasOut) annotation (Line(
            points={{16,32},{100,32},{100,0}},
            color={159,159,223},
            thickness=0.5));
        connect(gasFlow.infl, gasIn) annotation (Line(
            points={{-8,32},{-100,32},{-100,0}},
            color={159,159,223},
            thickness=0.5));
        connect(fluidAFlow.wall, metalTube_A.int) annotation (Line(
            points={{-28,-41},{-28,-23}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(fluidBFlow.wall, metalTube_B.int) annotation (Line(
            points={{28,-41},{28,-23}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(heatExchangerTopology_A.side2, metalTube_A.ext) annotation (Line(
            points={{-28,2.9},{-28,-16.9}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(heatExchangerTopology_B.side2, metalTube_B.ext) annotation (Line(
            points={{28,2.9},{28,-16.9}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(gasFlow.wall, heatExchangerTopology_A.side1) annotation (Line(
            points={{4,27},{4,20},{-28,20},{-28,9}},
            color={255,127,0},
            smooth=Smooth.None));
        connect(gasFlow.wall2, heatExchangerTopology_B.side1) annotation (Line(
            points={{4,37},{4,46},{28,46},{28,9}},
            color={255,127,0},
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                  -100},{100,100}}),
      ...
      model ParHE_Des
        ...
        replaceable model HeatTransfer_FA_p1 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatTransfer_FB_p1 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatTransfer_GA_p1 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatTransfer_GB_p1 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatExchangerTopology_A_p1 =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        constrainedby ThermoPower.Thermal.BaseClasses.HeatExchangerTopologyData
        annotation(choicesAllMatching=true);
        replaceable model HeatExchangerTopology_B_p1 =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        constrainedby ThermoPower.Thermal.BaseClasses.HeatExchangerTopologyData
        annotation(choicesAllMatching=true);

        replaceable model HeatTransfer_FA_p2 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatTransfer_FB_p2 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatTransfer_GA_p2 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatTransfer_GB_p2 =
            Thermal.HeatTransferFV.IdealHeatTransfer
        constrainedby ThermoPower.Thermal.BaseClasses.DistributedHeatTransferFV
        annotation (choicesAllMatching=true);
        replaceable model HeatExchangerTopology_A_p2 =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        constrainedby ThermoPower.Thermal.BaseClasses.HeatExchangerTopologyData
        annotation(choicesAllMatching=true);
        replaceable model HeatExchangerTopology_B_p2 =
            Thermal.HeatExchangerTopologies.CoCurrentFlow
        constrainedby ThermoPower.Thermal.BaseClasses.HeatExchangerTopologyData
        annotation(choicesAllMatching=true);
        ...
        parameter SI.SpecificEnthalpy hstart_valA=1e5
          "Specific enthalpy start value, valve A"
          annotation (Dialog(group="Desuperheater A"));
        parameter Real Cv_valB "Cv (US) flow coefficient, valve B"
        ...
        parameter SI.SpecificEnthalpy hstart_valB=1e5
          "Specific enthalpy start value, valve B"
          annotation (Dialog(group="Desuperheater B"));
        ...
        ParHE pHE1(
          ...
          redeclare model HeatTransfer_FA=HeatTransfer_FA_p1,
          redeclare model HeatTransfer_FB=HeatTransfer_FB_p1,
          redeclare model HeatTransfer_GA=HeatTransfer_GA_p1,
          redeclare model HeatTransfer_GB=HeatTransfer_GB_p1,
          redeclare model HeatExchangerTopology_A=HeatExchangerTopology_A_p1,
          redeclare model HeatExchangerTopology_B=HeatExchangerTopology_B_p1) annotation (Placement(transformation(
                extent={{-46,28},{-26,48}}, rotation=0)));
        ...
        ParHE pHE2(
          ...
          redeclare model HeatTransfer_FA=HeatTransfer_FA_p2,
          redeclare model HeatTransfer_FB=HeatTransfer_FB_p2,
          redeclare model HeatTransfer_GA=HeatTransfer_GA_p2,
          redeclare model HeatTransfer_GB=HeatTransfer_GB_p2,
          redeclare model HeatExchangerTopology_A=HeatExchangerTopology_A_p2,
          redeclare model HeatExchangerTopology_B=HeatExchangerTopology_B_p2) annotation (Placement(transformation(
                extent={{26,-36},{46,-16}}, rotation=0)));
        ...
        parameter Choices.FluidPhase.FluidPhases FluidPhaseStart_B=Choices.FluidPhase.FluidPhases.Liquid
          "Fluid phase (only for initialization!)";
      equation
        connect(pHE1.waterInB, waterInB) annotation (Line(
            points={{-32,48},{-32,54},{12,54},{12,100},{40,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(pHE1.waterInA, waterInA) annotation (Line(
            points={{-40,48},{-40,100}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(pHE2.gasIn, pHE1.gasOut) annotation (Line(
            ...
            color={159,159,223},
            thickness=0.5));
        connect(valveA.outlet, flowJoinA.in2) annotation (Line(
            points={{-18,-24},{-14,-24},{-14,-14},{-8,-14}},
            thickness=0.5,
            color={0,0,255}));
        connect(flowJoinA.in1, pHE1.waterOutA) annotation (Line(
            points={{-8,-2},{-14,-2},{-14,16},{-40,16},{-40,28}},
            thickness=0.5,
            color={0,0,255}));
        connect(flowJoinB.in1, pHE1.waterOutB) annotation (Line(
            points={{-8,22},{-32,22},{-32,28}},
            thickness=0.5,
            color={0,0,255}));
        connect(valveB.outlet, flowJoinB.in2) annotation (Line(
            points={{-18,10},{-12.95,10},{-8,10}},
            thickness=0.5,
            color={0,0,255}));
        connect(intermediate_A.outlet, pHE2.waterInA) annotation (Line(
            points={{27.2,-7.8},{32,-7.8},{32,-16}},
            thickness=0.5,
            color={0,0,255}));
        connect(intermediate_A.inlet, flowJoinA.out) annotation (Line(
            points={{18.8,-7.8},{18.8,-8},{10,-8}},
            thickness=0.5,
            color={0,0,255}));
        connect(intermediate_B.inlet, flowJoinB.out) annotation (Line(
            points={{18.8,16.2},{19.4,16.2},{19.4,16},{10,16}},
            thickness=0.5,
            color={0,0,255}));
        connect(intermediate_B.outlet, pHE2.waterInB) annotation (Line(
            points={{27.2,16.2},{27.2,16},{40,16},{40,-16}},
            thickness=0.5,
            color={0,0,255}));
        connect(waterOutB, pHE2.waterOutB) annotation (Line(
            points={{40,-100},{40,-36}},
            thickness=0.5,
            color={0,0,255}));
        connect(pHE2.waterOutA, waterOutA) annotation (Line(
            points={{32,-36},{32,-50},{-40,-50},{-40,-100}},
            thickness=0.5,
            color={0,0,255}));
        connect(T_intermedB, intermediate_B.T) annotation (Line(points={{101,39},
                {40,39},{40,23.2},{28.6,23.2}}, color={0,0,127}));
        connect(intermediate_A.T, T_intermedA) annotation (Line(points={{28.6,-0.8},
                {52,-0.8},{52,59},{101,59}}, color={0,0,127}));
        ...
        connect(theta_valveB, valveB.theta) annotation (Line(points={{101,-63},
              ...
              color={0,0,127}));
        connect(LiquidWaterIn_A, valveA.inlet) annotation (Line(
            points={{-100,-42},{-60,-42},{-60,-24},{-34,-24}},
            thickness=0.5,
            color={0,0,255}));
        connect(LiquidWaterIn_B, valveB.inlet) annotation (Line(
            points={{-100,-70},{-70,-70},{-70,10},{-34,10}},
            thickness=0.5,
            color={0,0,255}));
        annotation (Diagram(graphics));
      end ParHE_Des;
      ...
      model BaseReader_water
        ...
        Water.FlangeA inlet(redeclare package Medium = Medium, m_flow(min=if
                allowFlowReversal then -Modelica.Constants.inf else 0))
          annotation (Placement(transformation(extent={{-80,-20},{-40,20}},
                rotation=0)));
        Water.FlangeB outlet(redeclare package Medium = Medium, m_flow(max=if
                allowFlowReversal then +Modelica.Constants.inf else 0))
...
<li><i>1 Oct 2003</i>
    by <a href=\"mailto:francesco.casella@polimi.it\">Francesco Casella</a>:<br>
      ...
      model PrescribedSpeedPump "Prescribed speed pump"
        ...
        parameter SI.Conversions.NonUnits.SI.AngularVelocity_rpm n0
          "Nominal rpm";
        ...
        Water.Pump feedWaterPump(
          ...
          w0=nominalFlow) annotation (Placement(transformation(extent={{-40,-24},
                  {0,16}}, rotation=0)));
        Modelica.Blocks.Interfaces.RealInput pumpSpeed_rpm annotation (
            Placement(transformation(extent={{-92,40},{-52,80}}, rotation=0),
      ...
      equation
        connect(inlet, feedWaterPump.infl) annotation (Line(
            ...
            thickness=0.5,
            color={0,0,255}));
        connect(pumpSpeed_rpm, feedWaterPump.in_n) annotation (Line(points={{-72,
                60},{-25.2,60},{-25.2,12}}, color={0,0,127}));
      ...
      model PumpControlledFlowRate "Pump with flow rate control"
        ...
        parameter SI.Time Td=0 "Derivative time" annotation (Dialog(tab="PID"));
      ...
      equation
        connect(firstOrder.y, pump.pumpSpeed_rpm) annotation (Line(points={{-31,
                50},{-60,50},{-60,9.6},{-15.52,9.6}}, color={0,0,127}));
        ...
        annotation (Icon(graphics={Rectangle(
                      ...
                      fillColor={170,213,255},
                      fillPattern=FillPattern.Solid,
                      textString="F"),Line(points={{-48,70},{-2,70},{-2,60}},
                color={0,0,127}),Line(
                      points={{-62,0},{-80,0}},
                      color={0,0,255},
      ...
      model zzOld_ParHE "Parallel heat exchangers fluid - gas"
        extends Interfaces.ParallelHE;
        extends Modelica.Icons.ObsoleteModel;
        ...
        parameter Choices.Flow1D.HCtypes HCtype_F_B=ThermoPower.Choices.Flow1D.HCtypes.Downstream
          "Location of the hydraulic capacitance, fluid side"
          annotation (Dialog(group="side B"));
        parameter Boolean counterCurrent_A=true "Counter-current flow"
          annotation (Dialog(group="side A"));
        parameter Boolean counterCurrent_B=true "Counter-current flow"
          annotation (Dialog(group="side B"));
        ...
        ConvParallel convParallel(
          ...
          Aa=exchSurface_G_A,
          Ab=exchSurface_G_B) annotation (Placement(transformation(extent={{-10,
                  12},{10,32}}, rotation=0)));
        Water.Flow1D fluidAFlow(
          ...
          Cfnom=Cfnom_F_A,
          FluidPhaseStart=FluidPhaseStart_A,
          pstart=pstart_F_A) annotation (Placement(transformation(extent={{-38,
                  -56},{-18,-36}}, rotation=0)));
        Thermal.ConvHT convHT_A(N=N_F_A, gamma=gamma_F_A) annotation (Placement(
        ...
        Water.Flow1D fluidBFlow(
          ...
          Cfnom=Cfnom_F_B,
          FluidPhaseStart=FluidPhaseStart_B,
          pstart=pstart_F_B) annotation (Placement(transformation(extent={{38,-56},
                  {18,-36}}, rotation=0)));
        Thermal.ConvHT convHT_B(N=N_F_B, gamma=gamma_F_B) annotation (Placement(
        ...
        Thermal.MetalTube metalTube_B(
          ...
          rext=(metalVol_B + fluidVol_B)*4/extSurfaceTub_B/2,
          rhomcm=rhomcm_B,
          Tstartbar=Tstartbar_M_B) annotation (Placement(transformation(extent=
                  {{18,-6},{38,-26}}, rotation=0)));
        ...
        Thermal.HeatFlowDistribution heatFlowDistribution_A(
          N=N_F_A,
          A1=exchSurface_G_A,
          A2=extSurfaceTub_A) annotation (Placement(transformation(extent={{-38,
                  8},{-18,28}}, rotation=0)));
        ...
        Thermal.HeatFlowDistribution heatFlowDistribution_B(
          N=N_F_B,
          A1=exchSurface_G_B,
          A2=extSurfaceTub_B) annotation (Placement(transformation(extent={{18,
                  8},{38,28}}, rotation=0)));
        Thermal.ConvHT2N convHT2N_A(
          N1=N_G,
          N2=N_F_A,
          gamma=gamma_G_A) annotation (Placement(transformation(extent={{-38,24},
                  {-18,44}}, rotation=0)));
        Thermal.ConvHT2N convHT2N_B(
          N1=N_G,
          N2=N_F_B,
          gamma=gamma_G_B) annotation (Placement(transformation(extent={{18,24},
                  {38,44}}, rotation=0)));
        ...
        parameter Choices.FluidPhase.FluidPhases FluidPhaseStart_B=Choices.FluidPhase.FluidPhases.Liquid
          ...
          annotation (Dialog(tab="Initialization", group="side B"));
      equation
        connect(heatFlowDistribution_A.side2, cC_A.side1)
          annotation (Line(points={{-28,14.9},{-28,5}}, color={255,127,0}));
        connect(convHT_A.side2, fluidAFlow.wall)
          annotation (Line(points={{-28,-31.1},{-28,-41}}, color={255,127,0}));
        connect(heatFlowDistribution_B.side2, cC_B.side1)
          annotation (Line(points={{28,14.9},{28,5}}, color={255,127,0}));
        connect(convHT_B.side2, fluidBFlow.wall)
          annotation (Line(points={{28,-31.1},{28,-41}}, color={255,127,0}));
        connect(fluidBFlow.outfl, waterOutB) annotation (Line(
            points={{18,-46},{8,-46},{8,-100},{40,-100}},
            thickness=0.5,
        ...
        connect(metalTube_B.int, convHT_B.side1)
          annotation (Line(points={{28,-19},{28,-25}}, color={255,127,0}));
        connect(metalTube_A.int, convHT_A.side1)
          annotation (Line(points={{-28,-19},{-28,-25}}, color={255,127,0}));
        connect(metalTube_A.ext, cC_A.side2) annotation (Line(points={{-28,-12.9},
      ...
      model ConvParallel
        ...
        ThermoPower.Thermal.DHT source(N=N) annotation (Placement(
              transformation(extent={{-40,60},{40,80}}, rotation=0)));
        ThermoPower.Thermal.DHT objectA(N=N) annotation (Placement(
              transformation(extent={{-100,-40},{-20,-20}}, rotation=0)));
        ThermoPower.Thermal.DHT objectB(N=N) annotation (Placement(
              transformation(extent={{20,-40},{100,-20}}, rotation=0)));
...
<p>The model connected to the <tt>source</tt> connector exchanges power \"in parallel\" with the models connected to the <tt>objectA</tt> and <tt>objectB</tt> connectors.
      ...
      model zzOld_HE_simp "Simplified Heat Exchanger fluid - gas"
        ...
        Water.Flow1D fluidFlow(
          ...
          Dhyd=fluidVol*4/exchSurface_F,
          FluidPhaseStart=FluidPhaseStart,
          pstart=pstart_F) annotation (Placement(transformation(extent={{-10,-50},
                  {10,-30}}, rotation=0)));
        Thermal.ConvHT convHT(gamma=gamma_F, N=N_F) annotation (Placement(
        ...
        Thermal.ConvHT2N convHT2N(
          N1=N_G,
          N2=N_F,
          gamma=gamma_G) annotation (Placement(transformation(extent={{-10,10},
                  {10,30}}, rotation=0)));
        final parameter SI.Distance L=1 "Tube length";
        parameter Choices.FluidPhase.FluidPhases FluidPhaseStart=Choices.FluidPhase.FluidPhases.Liquid
          "Fluid phase (only for initialization!)"
      ...
      equation
        connect(fluidFlow.wall, convHT.side2)
          annotation (Line(points={{0,-35},{0,-23.1}}, color={255,127,0}));
        connect(gasFlow.infl, gasIn) annotation (Line(
        ...
        connect(gasFlow.outfl, gasOut) annotation (Line(
            ...
            thickness=0.5));
        connect(fluidFlow.outfl, waterOut) annotation (Line(
            points={{10,-40},{60,-40},{60,-100},{0,-100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidFlow.infl, waterIn) annotation (Line(
            points={{-10,-40},{-40,-40},{-40,100},{0,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(convHT2N.side1, gasFlow.wall)
          annotation (Line(points={{0,23},{0,35}}, color={255,127,0}));
        connect(metalTube.int, convHT.side1)
          annotation (Line(points={{0,-3},{0,-17}}, color={255,127,0}));
        connect(metalTube.ext, convHT2N.side2)
          annotation (Line(points={{0,3.1},{0,16.9}}, color={255,127,0}));
        annotation (Diagram(graphics));
      end zzOld_HE_simp;

      model zzOld_HE2ph "Heat Exchanger fluid - gas (2phases)"
        extends Interfaces.HeatExchanger;
        extends Modelica.Icons.ObsoleteModel;
        parameter SI.CoefficientOfHeatTransfer gamma_G
          "Constant heat transfer coefficient in the gas side";
      ...
      model zzOld_HE2ph_simp "Simplified Heat Exchanger fluid - gas (2phases)"
        extends Interfaces.HeatExchanger(extSurfaceTub=exchSurface_G);
        extends Modelica.Icons.ObsoleteModel;
        parameter SI.CoefficientOfHeatTransfer gamma_G
          "Constant heat transfer coefficient in the gas side";
      ...
      model zzOld_HEhtc_f
        ...
        Thermal.HeatFlowDistribution heatFlowDistribution(
          N=N_F,
          A1=exchSurface_G,
          A2=extSurfaceTub) annotation (Placement(transformation(extent={{-10,8},
                  {10,28}}, rotation=0)));
        Water.Flow1D fluidFlow_Extension(
          Nt=1,
          N=N_F,
          wnom=fluidNomFlowRate,
          initOpt=if SSInit then Options.steadyState else Options.noInit,
          ...
          Dhyd=fluidVol*4/exchSurface_F,
          FluidPhaseStart=FluidPhaseStart,
          pstart=pstart_F) annotation (Placement(transformation(extent={{-10,-56},
                  {10,-36}}, rotation=0)));
        Thermal.ConvHT convHT_htc(N=N_F, gamma=gamma_F) annotation (Placement(
              transformation(extent={{-10,-20},{10,-40}}, rotation=0)));
        Thermal.ConvHT2N_htc convHT2N(N1=N_G, N2=N_F) annotation (Placement(
      ...
      equation
        ...
        connect(gasFlow.outfl, gasOut) annotation (Line(
            ...
            thickness=0.5));
        connect(heatFlowDistribution.side2, cC.side1)
          annotation (Line(points={{0,14.9},{0,5}}, color={255,127,0}));
        connect(fluidFlow_Extension.infl, waterIn) annotation (Line(
            points={{-10,-46},{-40,-46},{-40,100},{0,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidFlow_Extension.outfl, waterOut) annotation (Line(
            points={{10,-46},{40,-46},{40,-100},{0,-100}},
            thickness=0.5,
            color={0,0,255}));
        connect(convHT2N.side2, heatFlowDistribution.side1)
          annotation (Line(points={{0,30.9},{0,21}}, color={255,127,0}));
        connect(metalTube.ext, cC.side2)
          annotation (Line(points={{0,-10.9},{0,-1.1}}, color={255,127,0}));
      ...
      model zzOld_ParHE_simp "Simplified parallel heat exchangers fluid - gas"
        extends Modelica.Icons.ObsoleteModel;
        ...
        Water.Flow1D fluidBFlow(
          ...
          wnom=fluidNomFlowRate_B,
          FluidPhaseStart=FluidPhaseStart_B,
          pstart=pstart_F_B) annotation (Placement(transformation(extent={{38,-52},
                  {18,-32}}, rotation=0)));
        Thermal.ConvHT convHT_B(N=N_F_B, gamma=gamma_F_B) annotation (Placement(
        ...
        Thermal.MetalTube metalTube_B(
          ...
          rhomcm=rhomcm_B,
          Tstartbar=Tstartbar_M_B) annotation (Placement(transformation(extent=
                  {{18,6},{38,-14}}, rotation=0)));
        Thermal.ConvHT2N convHT2N_A(
          N1=N_G,
          N2=N_F_A,
          gamma=gamma_G_A) annotation (Placement(transformation(extent={{-38,10},
                  {-18,30}}, rotation=0)));
        Thermal.ConvHT2N convHT2N_B(
          N1=N_G,
          N2=N_F_B,
          gamma=gamma_G_B) annotation (Placement(transformation(extent={{18,10},
                  {38,30}}, rotation=0)));
        final parameter SI.Distance L=1 "Tube length";
        parameter Choices.FluidPhase.FluidPhases FluidPhaseStart_A=Choices.FluidPhase.FluidPhases.Liquid
          "Fluid phase (only for initialization!)"
      ...
      equation
        connect(convHT_A.side2, fluidAFlow.wall)
          annotation (Line(points={{-28,-23.1},{-28,-37}}, color={255,127,0}));
        connect(convHT_B.side2, fluidBFlow.wall)
          annotation (Line(points={{28,-23.1},{28,-37}}, color={255,127,0}));
        connect(fluidBFlow.outfl, waterOutB) annotation (Line(
            points={{18,-42},{8,-42},{8,-100},{40,-100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidAFlow.outfl, waterOutA) annotation (Line(
            points={{-18,-42},{-8,-42},{-8,-100},{-40,-100}},
            ...
            color={0,0,255}));
        connect(fluidAFlow.infl, waterInA) annotation (Line(
            points={{-38,-42},{-50,-42},{-50,100},{-40,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(fluidBFlow.infl, waterInB) annotation (Line(
            points={{38,-42},{52,-42},{52,100},{40,100}},
            thickness=0.5,
            color={0,0,255}));
        connect(gasFlow.outfl, gasOut) annotation (Line(
        ...
        connect(metalTube_A.ext, convHT2N_A.side2)
          annotation (Line(points={{-28,-0.9},{-28,16.9}}, color={255,127,0}));
        connect(convHT_B.side1, metalTube_B.int)
          annotation (Line(points={{28,-17},{28,-7}}, color={255,127,0}));
        connect(metalTube_B.ext, convHT2N_B.side2)
          annotation (Line(points={{28,-0.9},{28,16.9}}, color={255,127,0}));
        annotation (Diagram(graphics));
      end zzOld_ParHE_simp;

      model zzOld_FlowGas1Dhtc
      ...
      equation
        ...
        annotation (Diagram(graphics));
      end zzOld_FlowGas1Dhtc;

      model zzOld_Flow1D2phhtc
      ...
      equation
        ...
        annotation (Diagram(graphics));
      end zzOld_Flow1D2phhtc;

      model zzOld_Flow1Dhtc
    ...
    package Control
      ...
      model levelsControl "PID controllers for levels control"
        ...
        PowerPlants.Control.PID Level_HP(
          ...
          CSstart=CSstart_levelHP) annotation (Placement(transformation(extent=
        ...
        PowerPlants.Control.PID Level_IP(
          ...
          CSstart=CSstart_levelIP) annotation (Placement(transformation(extent=
        ...
        PowerPlants.Control.PID Level_LP(
          ...
          CSstart=CSstart_levelLP) annotation (Placement(transformation(extent=
                  {{20,-54},{40,-34}}, rotation=0)));
      public
      ...
      public
        Modelica.Blocks.Sources.Constant levelLP_SP(k=setPoint_levelLP)
          annotation (Placement(transformation(
              ...
              rotation=180)));
      equation
        connect(SensorsBus.y_drumHP, Level_HP.PV) annotation (Line(points={{-100,
                0},{-60,0},{-60,30},{0,30},{0,46},{20,46}}, color={255,170,213}));
        connect(SensorsBus.y_drumIP, Level_IP.PV) annotation (Line(points={{-100,
                0},{-60,0},{-60,-20},{0,-20},{0,-4},{20,-4}}, color={255,170,
                213}));
        connect(SensorsBus.y_drumLP, Level_LP.PV) annotation (Line(points={{-100,
                0},{-60,0},{-60,-66},{0,-66},{0,-48},{20,-48}}, color={255,170,
                213}));
        connect(ActuatorsBus.flowRate_feedIP, Level_IP.CS)
          annotation (Line(points={{100,0},{40,0}}, color={213,255,170}));
        ...
        connect(levelHP_SP.y, Level_HP.SP)
          annotation (Line(points={{-19,54},{20,54}}, color={0,0,127}));
    ...
    package Examples "Example implementations"
      ...
      model HEG_2L "Heat Exchangers Group with two pressure level"
        ...
        parameter SI.MassFlowRate wnom_attShHP
          "Nominal mass flowrate, valve for Sh_HP attemperation"
          annotation (Dialog(group="Attemperation"));
        parameter SI.SpecificEnthalpy valShHP_hstart=1e5
          "Start value of specific enthalpy, valve for Sh_HP attemperation"
          annotation (Dialog(group="Attemperation"));
        ...
        replaceable Components.HE2ph Ev_LP(
          ...
          Tstartbar_G=Ev_LP_Tstartbar) constrainedby Interfaces.HeatExchanger(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Ev_LP_N_G,
          N_F=Ev_LP_N_F,
          ...
          lambda=lambda,
          FFtype_F=ThermoPower.Choices.Flow1D.FFtypes.NoFriction,
          Tstartbar_G=Ev_LP_Tstartbar) annotation (Placement(transformation(
                extent={{130,-10},{150,10}}, rotation=0)));
        ...
        Water.ValveLiq valveAttSh(
          ...
          dpnom=dpnom_attShHP,
          wnom=wnom_attShHP,
          Cv=Cv_attShHP) "valve for attemperation of the Sh" annotation (
        ...
        Water.FlowSplit flowSplit2(
          ...
          rev_in1=false,
          rev_out1=false,
          rev_out2=false) annotation (Placement(transformation(
              origin={-120,166},
              extent={{-10,-10},{10,10}},
              rotation=270)));
      equation
        connect(SensorsBus.T_Sh2HP_In, Sh2HPIn_T.T) annotation (Line(
            points={{400,140},{-148,140},{-148,-80},{-292,-80},{-292,16},{-350,
                16},{-350,40}},
            color={255,170,213},
            thickness=0.25));
        connect(SensorsBus.T_Sh2HP_Out, Sh2HPOut_T.T) annotation (Line(points={
                {400,140},{-148,140},{-148,-80},{-350,-80},{-350,-60}}, color={
                255,170,213}));
        connect(ActuatorsBus.theta_attShHP, valveAttSh.theta) annotation (Line(
            points={{400,80},{-320,80},{-320,130},{-339.6,130}},
            color={213,255,170},
            thickness=0.25));
        connect(mixAtt.in1, Sh1_HP.waterOut) annotation (Line(
            points={{-334,100},{-334,110},{-300,110},{-300,-40},{-220,-40},{-220,
                -10}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh2HPOut_T.inlet, Sh2_HP.waterOut) annotation (Line(
            points={{-340,-46},{-340,-28},{-340,-10}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh2_HP.waterIn, Sh2HPIn_T.outlet) annotation (Line(
            points={{-340,10},{-340,42}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh2HPIn_T.inlet, mixAtt.out) annotation (Line(
            points={{-340,54},{-340,54},{-340,82}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh1_HP.waterIn, Sh_HP_In) annotation (Line(
            points={{-220,10},{-220,40},{-280,40},{-280,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ev_HP.waterOut, Ev_HP_Out) annotation (Line(
            points={{-100,-10},{-100,-40},{-136,-40},{-136,60},{-240,60},{-240,
                200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ev_HP.waterIn, Ev_HP_In) annotation (Line(
            points={{-100,10},{-100,70},{-200,70},{-200,200}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(Sh_LP.waterOut, Sh_LP_Out) annotation (Line(
            points={{-20,-10},{-20,-80},{140,-80},{140,-200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh_HP_Out, Sh2HPOut_T.outlet) annotation (Line(
            points={{-200,-200},{-200,-140},{-340,-140},{-340,-58}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ev_LP.waterIn, Ev_LP_In) annotation (Line(
            points={{140,10},{140,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ev_LP.waterOut, Ev_LP_Out) annotation (Line(
            points={{140,-10},{140,-40},{100,-40},{100,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ec_LP.waterOut, Ec_LP_Out) annotation (Line(
            points={{220,-10},{220,-40},{180,-40},{180,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ec_LP.waterIn, Ec_LP_In) annotation (Line(
            points={{220,10},{220,200}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(mixAtt.in2, valveAttSh.outlet) annotation (Line(
            points={{-346,100},{-346,122}},
            thickness=0.5,
            color={0,0,255}));
        connect(flowSplit2.in1, Ec_HP_In) annotation (Line(
            points={{-120,172},{-120,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(flowSplit2.out2, valveAttSh.inlet) annotation (Line(
            points={{-124,160},{-124,150},{-346,150},{-346,138}},
            thickness=0.5,
            color={0,0,255}));
        connect(flowSplit2.out1, Ec_HP.waterIn) annotation (Line(
            points={{-116,160},{-116,150},{40,150},{40,10}},
            thickness=0.5,
            color={0,0,255}));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={
                  {-400,-200},{400,200}}), graphics));
      end HEG_2L;
      ...
      model HEG_2LRh "Heat Exchangers Group with two pressure level and reheat"
        ...
        parameter SI.SpecificEnthalpy valShHP_hstart
          "Specific enthalpy start value, valve for Sh_HP attemperation"
          annotation (dialog(group="Attemperation Sh"));
        parameter Real Cv_attRhIP
          "Cv (US) flow coefficient, valve for Rh_IP attemperation"
        ...
        parameter SI.MassFlowRate wnom_attRhIP
          "Nominal mass flowrate, valve for Rh_IP attemperation"
          annotation (dialog(group="Attemperation Rh"));
        parameter SI.SpecificEnthalpy valRhIP_hstart
          "Specific enthalpy start value, valve for Rh_IP attemperation"
          annotation (dialog(group="Attemperation Rh"));
        ...
        replaceable Components.HE2ph Ev_HP(
          ...
          lambda=lambda,
          Tstartbar_G=Ev_HP_Tstartbar) annotation (Placement(transformation(
                extent={{-210,-10},{-190,10}}, rotation=0)));
        replaceable Components.HE Ec_HP(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Ec_HP_N_G,
        ...
        replaceable Components.HE Sh_LP(
          ...
          extSurfaceTub=Sh_LP_extSurfaceTub,
          FluidPhaseStart=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh_LP_Tstartbar) constrainedby Interfaces.HeatExchanger(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Sh_LP_N_G,
          N_F=Sh_LP_N_F,
          ...
          extSurfaceTub=Sh_LP_extSurfaceTub,
          FluidPhaseStart=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh_LP_Tstartbar) annotation (Placement(transformation(
        ...
        replaceable Components.ParHE Sh1HP_Rh1IP(
          ...
          Tstartbar_G=Sh1_HP_Tstartbar) constrainedby
          ...
          FluidPhaseStart_A=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          FluidPhaseStart_B=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh1_HP_Tstartbar) annotation (Placement(transformation(
                extent={{-288,-12},{-264,12}}, rotation=0)));
        replaceable Components.ParHE Sh2HP_Rh2IP(
          ...
          FluidPhaseStart_A=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          FluidPhaseStart_B=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh2_HP_Tstartbar) constrainedby
          ThermoPower.PowerPlants.HRSG.Interfaces.ParallelHE(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          gasNomFlowRate=gasNomFlowRate,
          ...
          FluidPhaseStart_A=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          FluidPhaseStart_B=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh2_HP_Tstartbar) annotation (Placement(transformation(
                extent={{-360,-12},{-336,12}}, rotation=0)));
      equation
        connect(Ec_LP.waterIn, Ec_LP_In) annotation (Line(
            points={{220,10},{220,200}},
            thickness=0.5,
        ...
        connect(Sh_LP.gasIn, Ev_HP.gasOut) annotation (Line(
            ...
            thickness=0.5));
        connect(Ev_HP.waterOut, Ev_HP_Out) annotation (Line(
            points={{-200,-10},{-200,-60},{-240,-60},{-240,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ev_HP.waterIn, Ev_HP_In) annotation (Line(
            points={{-200,10},{-200,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh_LP.waterIn, Sh_LP_In) annotation (Line(
            points={{-20,10},{-20,80},{60,80},{60,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ec_HP.waterIn, Ec_HP_In) annotation (Line(
            points={{48,10},{48,68},{-120,68},{-120,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Ec_HP.waterOut, Ec_HP_Out) annotation (Line(
            points={{48,-10},{48,-40},{-160,-40},{-160,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh_LP.waterOut, Sh_LP_Out) annotation (Line(
            points={{-20,-10},{-20,-60},{140,-60},{140,-200}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(Ev_HP.gasIn, Sh1HP_Rh1IP.gasOut) annotation (Line(
            ...
            color={159,159,223},
            thickness=0.5));
        connect(Sh1HP_Rh1IP.waterInB, Rh_IP_In) annotation (Line(
            points={{-271.2,12},{-271.2,44},{-252,44},{-252,-94},{1.77636e-015,
                -94},{1.77636e-015,-200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Sh1HP_Rh1IP.waterOutB, Sh2HP_Rh2IP.waterInB) annotation (Line(
            points={{-271.2,-12},{-270,-12},{-270,-58},{-324,-58},{-324,28},{-343.2,
                28},{-343.2,12}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(Rh_IP_Out, Sh2HP_Rh2IP.waterOutB) annotation (Line(
            ...
            thickness=0.5));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={
                  {-400,-200},{400,200}}), graphics), Icon(graphics));
      end HEG_2LRh;
      ...
      model HEG_3LRh
        ...
        replaceable Components.ParHE Sh1HP_Rh1IP(
          ...
          FluidPhaseStart_B=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh1_HP_Tstartbar) annotation (Placement(transformation(
                extent={{-388,-12},{-364,12}}, rotation=0)));
        replaceable Components.ParHE Sh2HP_Rh2IP(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          gasNomFlowRate=gasNomFlowRate,
          ...
          FluidPhaseStart_B=ThermoPower.Choices.FluidPhase.FluidPhases.Steam,
          Tstartbar_G=Sh2_HP_Tstartbar) annotation (Placement(transformation(
                extent={{-460,-12},{-436,12}}, rotation=0)));
        ...
        replaceable Components.ParHE Ec1HP_EcIP(
          ...
          rhomcm_A=rhomcm,
          rhomcm_B=rhomcm,
          Tstartbar_G=Ec1_HP_Tstartbar) constrainedby
          ThermoPower.PowerPlants.HRSG.Interfaces.ParallelHE(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Ec1_HP_N_G,
          ...
          rhomcm_A=rhomcm,
          rhomcm_B=rhomcm,
          Tstartbar_G=Ec1_HP_Tstartbar) annotation (Placement(transformation(
                extent={{178,-12},{202,12}}, rotation=0)));
        replaceable Components.HE Ec_LP(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Ec_LP_N_G,
        ...
        replaceable Components.HE2ph Ev_LP(
          ...
          fluidNomPressure=fluidLPNomPressure_Ev,
          Tstartbar_G=Ev_LP_Tstartbar) annotation (Placement(transformation(
                extent={{288,-14},{312,10}}, rotation=0)));
        replaceable Components.HE Ev_IP(
          ...
          fluidNomFlowRate=fluidIPNomFlowRate_Ev,
          fluidNomPressure=fluidIPNomPressure_Ev,
          Tstartbar_G=Ev_IP_Tstartbar) annotation (Placement(transformation(
        ...
        replaceable Components.HE Sh_LP(
          ...
          Tstartbar_G=Sh_LP_Tstartbar,
          FluidPhaseStart=ThermoPower.Choices.FluidPhase.FluidPhases.Steam)
          constrainedby ThermoPower.PowerPlants.HRSG.Interfaces.HeatExchanger(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          N_G=Sh_LP_N_G,
          N_F=Sh_LP_N_F,
          ...
          Tstartbar_G=Sh_LP_Tstartbar,
          FluidPhaseStart=ThermoPower.Choices.FluidPhase.FluidPhases.Steam)
          annotation (Placement(transformation(extent={{108,-12},{132,12}},
                rotation=0)));
        replaceable Components.HE2ph Ev_HP(
          redeclare package FlueGasMedium = FlueGasMedium,
          redeclare package FluidMedium = FluidMedium,
          ...
          lambda=lambda,
          Tstartbar_G=Ev_HP_Tstartbar) annotation (Placement(transformation(
                extent={{-312,-12},{-288,12}}, rotation=0)));
        replaceable Components.HE Sh_IP(
          ...
          Tstartbar_G=Sh_IP_Tstartbar,
          FluidPhaseStart=ThermoPower.Choices.FluidPhase.FluidPhases.Steam)
          annotation (Placement(transformation(extent={{-218,-12},{-194,12}},
                rotation=0)));
        Water.Mixer mixIP(
          redeclare package Medium = FluidMedium,
          initOpt=if SSInit then ThermoPower.Choices.Init.Options.steadyState
      ...
      equation
        ...
        connect(Ev_HP.gasIn, Sh1HP_Rh1IP.gasOut) annotation (Line(
            ...
            color={159,159,223},
            thickness=0.5));
        connect(mixIP.in1, Rh_IP_In) annotation (Line(
            points={{-244,-116},{-130,-116},{-130,-200}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(Sh1HP_Rh1IP.waterOutB, Sh2HP_Rh2IP.waterInB) annotation (Line(
            ...
            smooth=Smooth.None));
        connect(Sh1HP_Rh1IP.waterOutA, Sh2HP_Rh2IP.waterInA) annotation (Line(
            points={{-380.8,-12},{-380.8,-40},{-410,-40},{-410,40},{-452.8,40},
                {-452.8,12}},
            color={0,0,255},
            thickness=0.5,
            smooth=Smooth.None));
        ...
        connect(Ec2_HP.waterOut, Ec_HP_Out) annotation (Line(
            ...
            smooth=Smooth.None));
        annotation (
          Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-500,-200},
                  {500,200}}), graphics),
          Icon(graphics),
          DymolaStoredErrors);
      end HEG_3LRh;
      ...
      model HEG_3LRh_des
        ...
        replaceable Components.ParHE_Des ShHP_RhIP(
          ...
          Tstartbar_G_p2=Sh1_HP_Tstartbar) constrainedby
          ...
          FluidPhaseStart_A=ThermoPower.Choices.FluidPhase.FluidPhases.Liquid,
          FluidPhaseStart_B=ThermoPower.Choices.FluidPhase.FluidPhases.Steam)
          annotation (Placement(transformation(extent={{-454,-24},{-406,24}},
                rotation=0)));
        ...
        replaceable Components.HE2ph Ev_LP(
          ...
          fluidNomPressure=fluidLPNomPressure_Ec,
          Tstartbar_G=Ec_LP_Tstartbar) annotation (Placement(transformation(
                extent={{288,-12},{312,12}}, rotation=0)));
      ...
      equation
        ...
        connect(RhIPOut_T.outlet, Rh_IP_Out) annotation (Line(
            ...
            thickness=0.5,
            color={0,0,255}));
        connect(ShHPOut_T.outlet, Sh_HP_Out) annotation (Line(
            points={{-364,-160},{-300,-160},{-300,-200}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(Rh_IP_In, mixIP.in1) annotation (Line(
            points={{-130,-200},{-130,-116},{-262,-116}},
            thickness=0.5,
            color={0,0,255}));
        connect(flowSplit2.in1, Ec_HP_In) annotation (Line(
            points={{-220,156},{-220,200}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(ShHPOut_T.inlet, ShHP_RhIP.waterOutA) annotation (Line(
            ...
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={
                  {-500,-200},{500,200}}), graphics), Icon(graphics));
      end HEG_3LRh_des;
      ...
      model DG_2L_NC
        ...
        Components.DrumSensors HPd(
          ...
          pstart=HPd_pstart,
          Cm=HPd_Cm) "HP drum" annotation (Placement(transformation(extent={{-188,
                  -20},{-268,60}}, rotation=0)));
      ...
      equation
        connect(SensorsBus.p_drumHP, HPd.p_out) annotation (Line(points={{400,
                80},{200,80},{200,120},{-60,120},{-60,50},{-213.6,50},{-213.6,
                49.6}}, color={255,170,213}));
        connect(SensorsBus.y_drumHP, HPd.y_out) annotation (Line(points={{400,
                80},{200,80},{200,120},{-60,120},{-60,36},{-200.8,36}}, color={
                255,170,213}));
        connect(Steam_HP_Out, steamHP_w.outlet) annotation (Line(
            points={{-280,-300},{-280,-232}},
            thickness=0.5,
            color={0,0,255}));
        connect(steamHP_w.inlet, HPd.steam) annotation (Line(
            points={{-280,-208},{-280,80},{-252,80},{-252,48},{-251.2,48}},
            thickness=0.5,
            color={0,0,255}));
        connect(Feed_HP, HPd.feedwater) annotation (Line(
            points={{-160,-300},{-160,14},{-189.2,14}},
            thickness=0.5,
            color={0,0,255}));
        connect(blowDownHP.flange, HPd.blowdown) annotation (Line(
            points={{-228,-60},{-228,-19.2},{-228,-19.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(SensorsBus.p_drumLP, LPd.p_out) annotation (Line(points={{400,
                80},{200,80},{200,54},{126.4,54},{126.4,49.6}}, color={255,170,
                213}));
        connect(SensorsBus.y_drumLP, LPd.y_out) annotation (Line(points={{400,
                80},{300,80},{200,80},{200,36},{139.2,36}}, color={255,170,213}));
        connect(steamLP_w.inlet, LPd.steam) annotation (Line(
            points={{60,-208},{60,78},{88.8,78},{88.8,48}},
            thickness=0.5,
            color={0,0,255}));
        connect(Feed_LP, LPd.feedwater) annotation (Line(
            points={{180,-300},{180,14},{150.8,14}},
            thickness=0.5,
            color={0,0,255}));
        connect(blowDownLP.flange, LPd.blowdown) annotation (Line(
            points={{112,-60},{112,-19.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(Steam_LP_Out, steamLP_w.outlet) annotation (Line(
            points={{60,-300},{60,-232}},
            thickness=0.5,
            color={0,0,255}));
        connect(ActuatorsBus.flowRate_feedHP, IPfeedPump.in_w0) annotation (
            Line(points={{400,20},{302,20},{302,-140},{-42,-140},{-42,-156}},
              color={213,255,170}));
        connect(WaterForHP, IPfeedPump.outlet) annotation (Line(
            points={{-120,-300},{-120,-168},{-70,-168}},
            thickness=0.5,
            color={0,0,255}));
        connect(Downcomer_HP, HPd.downcomer) annotation (Line(
            points={{-200,-300},{-200,-8}},
            thickness=0.5,
            color={0,0,255}));
        connect(Riser_HP, HPd.riser) annotation (Line(
            points={{-240,-300},{-240,-120},{-259.2,-120},{-259.2,-2.8}},
            thickness=0.5,
            color={0,0,255}));
        connect(Riser_LP, LPd.riser) annotation (Line(
            points={{100,-300},{100,-120},{80.8,-120},{80.8,-2.8}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(Downcomer_LP, LPd.downcomer) annotation (Line(
            ...
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={
                  {-400,-300},{400,300}}), graphics), Icon(graphics));
      end DG_2L_NC;
      ...
      model DG_3L_CC
        ...
        Components.DrumSensors HPd(
          ...
          pstart=HPd_pstart,
          Cm=HPd_Cm) "HP drum" annotation (Placement(transformation(extent={{-288,
                  -4},{-368,76}}, rotation=0)));
        Components.DrumSensors IPd(
          ...
          pstart=IPd_pstart,
          Cm=IPd_Cm) "IP drum" annotation (Placement(transformation(extent={{10,
                  -4},{-70,76}}, rotation=0)));
        Components.DrumSensors LPd(
          redeclare package Medium = FluidMedium,
          rint=LPd_rint,
        ...
        Water.SensW steamLP_w(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(
              ...
              extent={{20,-20},{-20,20}},
              rotation=90)));
        Water.FlowSplit flowSplit annotation (Placement(transformation(
              extent={{-20,-20},{20,20}},
              rotation=180,
              origin={150,-134})));
        Water.FlowSplit flowSplit1 annotation (Placement(transformation(
              extent={{-20,-20},{20,20}},
              rotation=270,
              origin={292,-122})));
      equation
        connect(ActuatorsBus.flowRate_feedHP, feedPumpHP.in_w0) annotation (
            Line(points={{500,20},{440,20},{440,-20},{-140,-20},{-140,-172},{-208,
                -172}}, color={213,255,170}));
        connect(ActuatorsBus.flowRate_feedIP, feedPumpIP.in_w0) annotation (
            Line(points={{500,20},{440,20},{440,-20},{120,-20},{120,-174},{92,-174}},
              color={213,255,170}));
        ...
        connect(SensorsBus.p_drumHP, HPd.p_out) annotation (Line(points={{500,
                ...
                65.6}}, color={255,170,213}));
        connect(SensorsBus.p_drumIP, IPd.p_out) annotation (Line(points={{500,
                80},{400,80},{400,160},{40,160},{40,63.6},{-15.6,65.6}}, color=
                {255,170,213}));
        connect(SensorsBus.p_drumLP, LPd.p_out) annotation (Line(points={{500,
                80},{400,80},{400,68},{280.4,68},{280.4,65.6}}, color={255,170,
                213}));
        connect(SensorsBus.y_drumHP, HPd.y_out) annotation (Line(points={{500,
                80},{400,80},{400,160},{-160,160},{-160,54},{-300.8,54},{-300.8,
                52}}, color={255,170,213}));
        connect(SensorsBus.y_drumIP, IPd.y_out) annotation (Line(points={{500,
                80},{400,80},{400,160},{40,160},{40,52},{-2.8,52}}, color={255,
                170,213}));
        connect(SensorsBus.y_drumLP, LPd.y_out) annotation (Line(points={{500,
                80},{400,80},{400,52},{293.2,52}}, color={255,170,213}));
        connect(Steam_HP_Out, steamHP_w.outlet) annotation (Line(
            points={{-380,-300},{-380,-232}},
            thickness=0.5,
            color={0,0,255}));
        connect(steamHP_w.inlet, HPd.steam) annotation (Line(
            points={{-380,-208},{-380,100},{-352,100},{-352,64},{-351.2,64}},
            thickness=0.5,
            color={0,0,255}));
        connect(circulationPumpHP.inlet, HPd.downcomer) annotation (Line(
            points={{-300,-160},{-300,8}},
            thickness=0.5,
            color={0,0,255}));
        connect(Feed_HP, HPd.feedwater) annotation (Line(
            points={{-260,-300},{-260,30},{-289.2,30}},
            thickness=0.5,
            color={0,0,255}));
        connect(Steam_IP_Out, steamIP_w.outlet) annotation (Line(
            points={{-80,-300},{-80,-232}},
            thickness=0.5,
            color={0,0,255}));
        connect(circulationPumpIP.inlet, IPd.downcomer) annotation (Line(
            points={{3.67394e-015,-160},{0,-160},{0,6},{-2,8}},
            thickness=0.5,
            color={0,0,255}));
        connect(steamIP_w.inlet, IPd.steam) annotation (Line(
            points={{-80,-208},{-80,80},{-52,80},{-52,62},{-53.2,64}},
            thickness=0.5,
            color={0,0,255}));
        connect(Feed_IP, IPd.feedwater) annotation (Line(
            points={{40,-300},{40,30},{8.8,30}},
            thickness=0.5,
            color={0,0,255}));
        connect(steamLP_w.inlet, LPd.steam) annotation (Line(
            points={{220,-208},{220,80},{242.8,80},{242.8,64}},
            thickness=0.5,
            color={0,0,255}));
        connect(Steam_LP_Out, steamLP_w.outlet) annotation (Line(
            points={{220,-300},{220,-232}},
            thickness=0.5,
            color={0,0,255}));
        connect(Feed_LP, LPd.feedwater) annotation (Line(
            points={{340,-300},{340,30},{304.8,30}},
            thickness=0.5,
            color={0,0,255}));
        connect(blowDownHP.flange, HPd.blowdown) annotation (Line(
            points={{-328,-38},{-328,-3.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(blowDownIP.flange, IPd.blowdown) annotation (Line(
            points={{-28,-44},{-28,-3.2},{-30,-3.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(blowDownLP.flange, LPd.blowdown) annotation (Line(
            points={{272,-36},{272,-20},{272,-3.2},{266,-3.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(WaterForHP, feedPumpHP.outlet) annotation (Line(
            points={{-220,-300},{-220,-200}},
            thickness=0.5,
            color={0,0,255}));
        connect(WaterForIP, feedPumpIP.outlet) annotation (Line(
            points={{80,-300},{80,-202}},
            thickness=0.5,
            color={0,0,255}));
        connect(Riser_LP, LPd.riser) annotation (Line(
            points={{260,-300},{260,-100},{234.8,-100},{234.8,13.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(Downcomer_LP, circulationPumpLP.outlet) annotation (Line(
            points={{300,-300},{300,-300},{300,-228}},
            thickness=0.5,
            color={0,0,255}));
        connect(Downcomer_IP, circulationPumpIP.outlet) annotation (Line(
            points={{1.77636e-015,-300},{1.77636e-015,-252},{-3.67394e-015,-252},
                {-3.67394e-015,-200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Riser_IP, IPd.riser) annotation (Line(
            points={{-40,-300},{-40,-100},{-61.2,-100},{-61.2,13.2}},
            thickness=0.5,
            color={0,0,255}));
        connect(Downcomer_HP, circulationPumpHP.outlet) annotation (Line(
            points={{-300,-300},{-300,-200}},
            thickness=0.5,
            color={0,0,255}));
        connect(Riser_HP, HPd.riser) annotation (Line(
            points={{-340,-300},{-340,-100},{-359.2,-100},{-359.2,13.2}},
            thickness=0.5,
            color={0,0,255}));
    ...
    package Tests "Test cases"
      ...
      equation
        ...
        connect(sinkP_water_B.flange, T_waterOut_B.outlet) annotation (Line(
            ...
            thickness=0.5,
            color={0,0,255}));
        connect(T_waterOut_B.inlet, hE.waterOutB) annotation (Line(
            points={{8,-34},{8,-27},{8,-20}},
            thickness=0.5,
            color={0,0,255}));
        connect(T_waterOut_A.inlet, hE.waterOutA) annotation (Line(
            points={{-8,-34},{-8,-27},{-8,-20}},
            thickness=0.5,
            color={0,0,255}));
        connect(hE.waterInA, T_waterIn_A.outlet) annotation (Line(
            points={{-8,20},{-8,20},{-8,24},{-8,34}},
            thickness=0.5,
            color={0,0,255}));
        connect(hE.waterInB, T_waterIn_B.outlet) annotation (Line(
            points={{8,20},{8,22},{8,34}},
            thickness=0.5,
            color={0,0,255}));
        connect(T_waterIn_B.inlet, sourseW_water_B.flange) annotation (Line(
            points={{8,46},{8,58},{20,58}},
            thickness=0.5,
            color={0,0,255}));
        connect(T_waterIn_A.inlet, sourseW_water_A.flange) annotation (Line(
            points={{-8,46},{-8,50},{-8,58},{-20,58}},
            thickness=0.5,
            color={0,0,255}));
      ...
      equation
        ...
        connect(T_waterOut_B.inlet, hE.waterOutB) annotation (Line(
            ...
            color={0,0,255}));
        connect(T_waterOut_A.inlet, hE.waterOutA) annotation (Line(
            points={{-8,-34},{-8,-32},{-10,-32},{-10,-28},{-8,-28},{-8,-20}},
            thickness=0.5,
            color={0,0,255}));
        connect(hE.waterInA, T_waterIn_A.outlet) annotation (Line(
            points={{-8,20},{-8,28},{-8,34}},
            thickness=0.5,
            color={0,0,255}));
        connect(hE.waterInB, T_waterIn_B.outlet) annotation (Line(
            points={{8,20},{8,20},{8,34}},
            thickness=0.5,
            color={0,0,255}));
        connect(T_waterIn_B.inlet, sourseW_water_B.flange) annotation (Line(
            points={{8,46},{8,58},{20,58}},
      ...
      model TestEc2HP
        ...
        parameter SI.Temperature Tstart_F_Out=594.14
          "Outlet fluid temperature start value";
        parameter SI.SpecificEnthalpy hstart_F_In=
            FluidMedium.specificEnthalpy_pT(fluidNomPressure, Tstart_F_In)
          "Nominal specific enthalpy";
        parameter SI.SpecificEnthalpy hstart_F_Out=
      ...
      equation
        ...
        connect(sinkP_water_B.flange, T_waterOut_B.outlet) annotation (Line(
            ...
            color={0,0,255}));
        connect(T_waterOut_B.inlet, hE.waterOutB) annotation (Line(
            points={{8,-34},{8,-26},{8,-20}},
            thickness=0.5,
            color={0,0,255}));
        connect(T_waterOut_A.inlet, hE.waterOutA) annotation (Line(
            points={{-8,-34},{-8,-28},{-8,-20}},
            thickness=0.5,
            color={0,0,255}));
        connect(hE.waterInA, T_waterIn_A.outlet) annotation (Line(
            points={{-8,20},{-8,34}},
      ...
      model TestHEG_3LRh
        ...
        Water.SourceMassFlow
          ...
          p0=fluidHPNomPressure_Ev,
          h=Ev_HP_hstart_F_In) annotation (Placement(transformation(
              origin={-52,64},
              extent={{-6,-6},{6,6}},
              rotation=270)));
        Water.SourceMassFlow
          ...
          h=Rh1_IP_hstart_F_In) annotation (Placement(transformation(
              origin={-19,-53},
              extent={{-5,-5},{5,5}},
              rotation=90)));
        Water.SinkPressure
          ...
          h=Rh2_IP_hstart_F_Out) annotation (Placement(transformation(
              ...
              extent={{6,-6},{-6,6}},
              rotation=90)));
        Modelica.Blocks.Sources.Constant commandValve annotation (Placement(
              transformation(
              origin={-1,-85},
              extent={{-5,-5},{5,5}},
              rotation=270)));
        ...
        Water.SourceMassFlow
          ...
          p0=fluidHPNomPressure_Ec,
          h=Ec1_HP_hstart_F_In) annotation (Placement(transformation(
              origin={-38,64},
              extent={{-6,-6},{6,6}},
              rotation=270)));
        Water.SinkPressure
        ...
        Water.SourceMassFlow
          ...
          p0=fluidIPNomPressure_Ev,
          h=Ev_IP_hstart_F_In) annotation (Placement(transformation(
              origin={-6,64},
              extent={{-6,-6},{6,6}},
              rotation=270)));
        Water.SinkPressure
        ...
        Water.SourceMassFlow
          ...
          p0=fluidIPNomPressure_Ec,
          h=Ec_IP_hstart_F_In) annotation (Placement(transformation(
              origin={10,64},
              extent={{-6,-6},{6,6}},
              rotation=270)));
        Water.SinkPressure
        ...
        Water.SourceMassFlow
          ...
          p0=fluidLPNomPressure_Ev,
          h=Ev_LP_hstart_F_In) annotation (Placement(transformation(
              origin={52,64},
              extent={{6,-6},{-6,6}},
              rotation=90)));
        Water.SinkPressure
        ...
        Water.SourceMassFlow
          ...
          p0=fluidLPNomPressure_Ec,
          h=Ec_LP_hstart_F_In) annotation (Placement(transformation(
              origin={68,64},
              extent={{6,-6},{-6,6}},
              rotation=90)));
        ...
        ThermoPower.PowerPlants.HRSG.Components.StateReader_gas stateGas_out(
            redeclare package Medium = FlueGasMedium) annotation (Placement(
              transformation(extent={{64,-12},{80,4}}, rotation=0)));
        inner System system(allowFlowReversal=false)
          annotation (Placement(transformation(extent={{80,80},{100,100}})));
      ...
      equation
        ...
        connect(commandValve.y, valveLinHP.cmd) annotation (Line(points={{-1,-90.5},
                {-1,-98},{-74,-98},{-74,-88.8}}, color={0,0,127}));
        connect(commandValve.y, valveLinLP.cmd) annotation (Line(points={{-1,-90.5},
                {-1,-98},{56,-98},{56,-90.8}}, color={0,0,127}));
    ...
    package TestsControl "Closed-loop test cases"
      ...
      public
        Modelica.Blocks.Sources.Ramp n_pump(
          ...
          offset=89.9,
          startTime=500,
          height=0) annotation (Placement(transformation(extent={{64,34},{52,46}},
                rotation=0)));
      ...
      model TestHRSG_wac
        ...
        Water.SteamTurbineStodola turbineHP(
          ...
          Kt=0.0032078,
          PRstart=4,
          pnom=12000000) annotation (Placement(transformation(extent={{-46,-92},
                  {-26,-72}},rotation=0)));
        ...
        ThermoPower.PowerPlants.HRSG.Control.levelsControl
          ...
          Level_LP(steadyStateInit=true)) annotation (Placement(transformation(
      ...
      equation
        ...
        connect(stateGas_out.inlet, hRSG.GasOut) annotation (Line(
            ...
            color={159,159,223},
            thickness=0.5));
        connect(OutLP.flange, turbineLP.outlet) annotation (Line(
            points={{64,-74},{52,-74}},
            thickness=0.5,
            color={0,0,255}));
        connect(turbineHP.shaft_b, turbineIP.shaft_a)
          annotation (Line(points={{-29.6,-82},{-14.6,-82}}, color={0,0,0}));
        connect(turbineIP.shaft_b, turbineLP.shaft_a)
          annotation (Line(points={{-1.6,-82},{37.4,-82}}, color={0,0,0}));
        connect(mixLP.in2, turbineIP.outlet) annotation (Line(
            points={{11,-74},{0,-74}},
            thickness=0.5,
            color={0,0,255}));
        connect(constantSpeed.flange, turbineLP.shaft_b) annotation (Line(
              points={{88,-83},{88,-82},{50.4,-82}}, color={0,0,0}));
        connect(turbineLP.inlet, mixLP.out) annotation (Line(
            points={{36,-74},{36,-71},{20,-71}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(actuators, levelsControlSimplified.ActuatorsBus) annotation (
            Line(points={{64,-16},{92,-16},{92,70},{80,70}}, color={213,255,170}));
        connect(totalFeedPump.pumpSpeed_rpm, actuators.nPump_feedLP)
          annotation (Line(points={{48.32,-36.4},{64,-36.4},{64,-16}}, color={0,
                0,127}));
        connect(totalFeedPump.outlet, hRSG.WaterIn) annotation (Line(
            points={{38,-40},{24,-40},{24,-6}},
            thickness=0.5,
            color={0,0,255}));
  ...
  package SteamTurbineGroup
    ...
    package Interfaces "Interface definitions"
      partial model ST_2L
        ...
        parameter SI.Area HPT_Kt "Flow coefficient"
        ...
        parameter Real HPT_eta_iso_nom=0.92 "Nominal isentropic efficiency"
          annotation (Dialog(group="HP Turbine"));
        parameter SI.Area LPT_Kt "Flow coefficient"
        ...
        Water.FlangeB LPT_Out(redeclare package Medium = FluidMedium)
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{-120,30},{-120,200}},
                color={0,0,255}),Line(points={{0,30},{0,200}}, color={0,0,255}),
                Line(points={{60,-90},{60,-192}}, color={0,0,255}),Polygon(
      ...
      partial model ST_3L
        ...
        parameter Real HPT_eta_iso_nom=0.92 "Nominal isentropic efficiency"
          annotation (Dialog(group="HP Turbine"));
        parameter SI.Area IPT_Kt "Flow coefficient"
        ...
        parameter SI.Pressure LPT_pstart_out=pcond
          ...
          annotation (Dialog(tab="Initialization", group="LP Turbine"));
        parameter SI.MassFlowRate LPT_wstart=steamLPNomFlowRate +
            steamIPNomFlowRate + steamHPNomFlowRate
          "Mass flow rate start value"
          annotation (Dialog(tab="Initialization", group="LP Turbine"));
        ...
        Water.FlangeA HPT_In(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-180,180},{-140,220}},
                rotation=0)));
        Water.FlangeB HPT_Out(redeclare package Medium = FluidMedium)
        ...
        Water.FlangeA IPT_In(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-60,180},{-20,220}},
                rotation=0)));
        Water.FlangeA LPT_In(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{60,180},{100,220}},
                rotation=0)));
        Water.FlangeB LPT_Out(redeclare package Medium = FluidMedium)
      ...
      partial model ST_2LHU
        ...
        Water.FlangeB SteamForHU(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-80,-220},{-40,-180}},
                rotation=0)));
        Water.FlangeB LPT_Out(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{28,-220},{68,-180}},
                rotation=0)));
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-60,-198},{-60,
                -140},{140,-140},{140,130},{0,130}}, color={0,0,255}),Line(
                points={{-60,90},{-60,130},{0,130}}, color={0,0,255}),Line(
                points={{0,130},{0,198}}, color={0,0,255}),Rectangle(
                      extent={{-200,14},{200,-14}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{-120,28},{-120,200}},
                color={0,0,255}),Line(points={{48,-90},{48,-192}}, color={0,0,
                255}),Line(points={{-12,130},{-12,120},{-12,30}}, color={0,0,
                255}),Polygon(
      ...
      partial model ST_2LRhHU
        ...
        annotation (Icon(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-98,132},{
                140,132},{140,-140},{-40,-140},{-40,-198}}, color={0,0,255}),
                Line(points={{80,132},{80,192}}, color={0,0,255}),Line(points={
                {-160,198},{-160,30}}, color={0,0,255}),Line(points={{-100,200},
                {-100,88}}, color={0,0,255}),Line(points={{-40,200},{-40,30}},
                color={0,0,255}),Rectangle(
                      extent={{-200,14},{200,-14}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{80,-90},{80,-198}},
      ...
      partial model ST_2LRh_3t
        ...
        Water.FlangeB Tap3(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{-10,-210},{10,-190}}, rotation=0)));
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={170,170,255},
                      fillColor={230,230,230},
                      fillPattern=FillPattern.Solid),Line(points={{-160,198},{-160,
                30}}, color={0,0,255}),Line(points={{-100,200},{-100,86}},
                color={0,0,255}),Line(points={{-40,200},{-40,30}}, color={0,0,
                255}),Rectangle(
                      extent={{-200,14},{202,-14}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{20,52},{20,140},{
                80,140},{80,198}}, color={0,0,255}),Line(points={{80,-76},{80,-198}},
                color={0,0,255}),Line(
      ...
      partial model ST_3LRh_7t
        ...
        Water.FlangeB Tap3(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{-100,-210},{-80,-190}}, rotation=
                  0)));
        Water.FlangeB Tap4(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{-60,-210},{-40,-190}}, rotation=0)));
        Water.FlangeB Tap5(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{-20,-210},{0,-190}}, rotation=0)));
        Water.FlangeB Tap6(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{20,-210},{40,-190}}, rotation=0)));
        Water.FlangeB Tap7(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{60,-210},{80,-190}}, rotation=0)));
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{-100,200},{-100,88}},
                color={0,0,255}),Line(points={{-40,30},{-40,200}}, color={0,0,
                255}),Line(points={{80,30},{80,200}}, color={0,0,255}),Line(
                points={{20,84},{20,130},{80,130}}, color={0,0,255}),Ellipse(
                      extent={{76,134},{84,126}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{140,-84},{
                140,-200}}, color={0,0,255}),Line(points={{-160,30},{-160,120},
                {-160,146},{-160,204}}, color={0,0,255}),Line(
      ...
      partial model Condenser "Base class for condenser"
        ...
        Water.FlangeB waterOut(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-30,-120},{10,-80}},
                rotation=0)));
        Water.FlangeA coolingIn(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{80,-60},{120,-20}},
                rotation=0)));
        Water.FlangeB coolingOut(redeclare package Medium = FluidMedium)
      ...
      partial model CondPlant_base
        ...
        annotation (Diagram(graphics), Icon(graphics={Rectangle(
                      ...
                      color={0,0,255},
                      thickness=0.5),Line(points={{0,60},{0,100}}, color={0,0,
                255}),Line(points={{0,-60},{0,-100}}, color={0,0,255})}));
      ...
      partial model CondPlantHU_base
        ...
        annotation (Diagram(graphics), Icon(graphics={Rectangle(
                      ...
                      points={{40,30},{-40,30},{38,0},{-40,-30},{40,-30}},
                      color={0,0,255},
                      thickness=0.5),Line(points={{0,-60},{0,-98}}, color={0,0,
                255}),Line(points={{-60,0},{-80,0},{-80,70},{-50,70},{-50,102}},
                color={0,0,255}),Line(points={{0,60},{0,70},{50,70},{50,88}},
                color={0,0,255})}));
      ...
      partial model CondPlantHU
        ...
        annotation (Diagram(graphics), Icon(graphics={Rectangle(
                      ...
                      color={0,0,255},
                      thickness=0.5),Line(points={{0,-60},{0,-98}}, color={0,0,
                255}),Line(points={{-60,0},{-80,0},{-80,80},{-50,80},{-50,102}},
                color={0,0,255}),Line(points={{0,60},{0,80},{50,80},{50,98}},
                color={0,0,255})}));
      ...
      partial model STGroup2L
        ...
        Water.FlangeA From_SH_HP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-140,180},{-100,220}},
                rotation=0)));
        Water.FlangeA From_SH_LP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-20,180},{20,220}},
                rotation=0)));
        Water.FlangeB WaterOut(redeclare package Medium = FluidMedium)
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{60,-126},{60,
                -78}}, color={0,0,255}),Ellipse(
                      extent={{40,-126},{80,-166}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{70,-136},{50,
                -136},{70,-146},{50,-156},{70,-156},{70,-156}}, color={0,0,255}),
                Line(points={{60,-170},{60,-180},{140,-180},{140,200}}, color={
                0,0,255}),Ellipse(
                      extent={{126,-132},{154,-160}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{140,-160},{
                140,-132},{152,-154},{140,-132},{128,-154}}, color={0,0,255}),
                Rectangle(
                      extent={{-200,14},{200,-14}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
      ...
      partial model STGroup2LRh
        ...
        Water.FlangeA From_SH_HP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-180,180},{-140,220}},
                rotation=0)));
        Water.FlangeB To_RH_IP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-120,180},{-80,220}},
                rotation=0)));
        Water.FlangeA From_RH_IP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-60,180},{-20,220}},
                rotation=0)));
        Water.FlangeA From_SH_LP(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{60,180},{100,220}},
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{80,-128},{80,
                -80}}, color={0,0,255}),Ellipse(
                      extent={{60,-126},{100,-166}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{90,-136},{70,
                -136},{90,-146},{70,-156},{90,-156},{90,-156}}, color={0,0,255}),
                Line(points={{80,-170},{80,-180},{160,-180},{160,196}}, color={
                0,0,255}),Ellipse(
                      extent={{146,-132},{174,-160}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{160,-160},{
                160,-132},{172,-154},{160,-132},{148,-154}}, color={0,0,255}),
                Line(points={{-160,198},{-160,30}}, color={0,0,255}),Line(
                points={{-100,200},{-100,88}}, color={0,0,255}),Line(points={{-40,
                200},{-40,30}}, color={0,0,255}),Rectangle(
                      extent={{-200,14},{200,-14}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{20,58},{20,140},{
                80,140},{80,198}}, color={0,0,255}),Polygon(
                      points={{-166,148},{-154,148},{-160,132},{-166,148}},
                      lineColor={0,0,255},
                      fillPattern=FillPattern.Solid,
                      fillColor={0,0,255}),Polygon(
      ...
      partial model STGroup3LRh
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{110,-136},{
                90,-136},{110,-146},{90,-156},{110,-156},{110,-156}}, color={0,
                0,255}),Line(points={{100,-168},{100,-186},{160,-186},{160,202}},
                color={0,0,255}),Line(points={{140,-88},{140,-110},{100,-110},{
                100,-126}}, color={0,0,255}),Ellipse(
                      extent={{146,-132},{174,-160}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{160,-160},{
                ...
                points={{20,90},{20,130},{80,130}}, color={0,0,255}),Ellipse(
                      ...
                      lineThickness=0.5,
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-160,30},{-160,
                120},{-160,146},{-160,204}}, color={0,0,255}),Polygon(
                      points={{-166,148},{-154,148},{-160,132},{-166,148}},
                      lineColor={0,0,255},
                      fillPattern=FillPattern.Solid,
                      fillColor={0,0,255}),Polygon(
      ...
      partial model STGroup2LHU
        ...
        Water.FlangeB WaterOut(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{120,180},{160,220}},
                rotation=0)));
        Water.FlangeA WaterFromHU(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{120,-220},{160,-180}},
                rotation=0)));
        Water.FlangeB SteamForHU(redeclare package Medium = FluidMedium)
          annotation (Placement(transformation(extent={{-80,-220},{-40,-180}},
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{48,-134},{48,
                -70}}, color={0,0,255}),Ellipse(
                      extent={{28,-132},{68,-172}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{58,-142},{38,
                -142},{58,-152},{38,-162},{58,-162},{58,-162}}, color={0,0,255}),
                Ellipse(
                      extent={{136,-136},{144,-144}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{140,-140},{
                140,-198}}, color={0,0,255}),Line(points={{140,-140},{140,190}},
                color={0,0,255}),Line(points={{48,-174},{48,-186},{110,-186},{
                110,-140},{140,-140}}, color={0,0,255}),Ellipse(
                      extent={{126,-92},{154,-120}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{140,-120},{
                140,-92},{152,-114},{140,-92},{128,-114}}, color={0,0,255}),
                Ellipse(
                      extent={{-20,136},{-12,128}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-60,-196},{-60,
                -110},{100,-110},{100,132},{0,132}}, color={0,0,255}),Line(
                points={{-60,92},{-60,132},{0,132}}, color={0,0,255}),Line(
                points={{0,132},{0,200}}, color={0,0,255}),Rectangle(
                      extent={{-200,16},{200,-12}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillPattern=FillPattern.HorizontalCylinder,
                      fillColor={135,135,135}),Line(points={{-120,30},{-120,202}},
                color={0,0,255}),Line(points={{-12,132},{-12,122},{-12,32}},
      ...
      partial model STGroup2LRhHU
        ...
        annotation (Diagram(coordinateSystem(
              ...
              initialScale=0.1), graphics={Rectangle(
                      ...
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{80,-134},{80,
                -74}}, color={0,0,255}),Ellipse(
                      extent={{60,-132},{100,-172}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{90,-142},{70,
                -142},{90,-152},{70,-162},{90,-162},{90,-162}}, color={0,0,255}),
                Ellipse(
                      extent={{156,-136},{164,-144}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{160,-140},{
                160,-198}}, color={0,0,255}),Line(points={{160,-140},{160,194}},
                color={0,0,255}),Line(points={{80,-176},{80,-186},{130,-186},{
                130,-140},{160,-140}}, color={0,0,255}),Ellipse(
                      extent={{146,-92},{174,-120}},
                      lineColor={0,0,255},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{160,-120},{
                160,-92},{172,-114},{160,-92},{148,-114}}, color={0,0,255}),
                Ellipse(
                      extent={{76,136},{84,128}},
                      lineColor={0,0,255},
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Line(points={{-98,132},{
                134,132},{134,-110},{-40,-110},{-40,-198}}, color={0,0,255}),
                Line(points={{80,132},{80,192}}, color={0,0,255}),Line(points={
                {-160,198},{-160,30}}, color={0,0,255}),Line(points={{-100,200},
                {-100,88}}, color={0,0,255}),Line(points={{-40,200},{-40,30}},
                color={0,0,255}),Rectangle(
    ...
    package Components "Component definitions"
      ...
      model CondenserPreP "Ideal condenser with prescribed pressure"
        ...
        Water.FlangeA steamIn(redeclare package Medium = Medium, m_flow(min=if
          ...
          annotation (Placement(transformation(extent={{-20,80},{20,120}},
                rotation=0)));
        Water.FlangeB waterOut(redeclare package Medium = Medium, m_flow(max=
        ...
        Modelica.Blocks.Interfaces.RealOutput Qcond annotation (Placement(
              ...
              extent={{-10,-10},{10,10}},
              rotation=180)));
        Modelica.Blocks.Interfaces.RealOutput ratio_Vv_Vtot annotation (
            Placement(transformation(
              origin={-100,-20},
              extent={{-10,-10},{10,10}},
              rotation=180)));
      ...
      model CondenserPreP_tap
        ...
        Modelica.Blocks.Interfaces.RealOutput ratio_Vv_Vtot annotation (
            Placement(transformation(
              ...
              extent={{-10,-10},{10,10}},
              rotation=180)));
        Water.FlangeB tapWater(redeclare package Medium = Medium) annotation (
      ...
      equation
        w = Kt*partialArc*sqrt(Medium.pressure(steamState_in)*Medium.density(
          steamState_in))*ThermoPower.Functions.sqrtReg(1 - (1/PR)^2)
          "Stodola's law";
      ...
      model SteamTurbine_1tapping "Turbine with one tapping"
        ...
        Water.FlangeB tap1(redeclare package Medium = FluidMedium) annotation (
            Placement(transformation(extent={{-6,-88},{12,-70}}, rotation=0)));
      ...
      equation
        ...
        connect(flangeB, ST_secondStages.outlet) annotation (Line(
            ...
            color={0,0,255},
            thickness=0.5));
        connect(partialArc, ST_firstStages.partialArc) annotation (Line(points=
                {{-58,-38},{-36,-38},{-36,-26},{-52,-26},{-52,-7.2},{-35,-7.2}},
              color={0,0,127}));
        ...
        connect(ST_firstStages.outlet, tap1) annotation (Line(
            ...
            smooth=Smooth.None));
        annotation (Diagram(graphics), Icon(graphics={Polygon(
                      points={{-26,76},{-26,28},{-20,28},{-20,82},{-58,82},{-58,
                  76},{-26,76}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillColor={0,0,255},
                      fillPattern=FillPattern.Solid),Polygon(
                      points={{28,56},{34,56},{34,76},{62,76},{62,82},{28,82},{
                  28,56}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillColor={0,0,255},
      ...
      equation
        ...
        annotation (
          ...
          Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{
                  100,100}}), graphics={Line(points={{0,-100},{0,100}}, color={
                0,0,255}),Text(
...
Model of <b>fixed</b> angular verlocity of flange, not dependent on torque.
      ...
      model Comp_bubble_h
        ...
        Modelica.Blocks.Interfaces.RealOutput h annotation (Placement(
    ...
    package Examples "Example implementations"
      ...
      model ST3L_base "Steam turbine with three pressure levels"
        ...
        Water.SteamTurbineStodola ST_HP(
          ...
          pnom=steamHPNomPressure) annotation (Placement(transformation(extent=
                  {{-152,-20},{-112,20}}, rotation=0)));
        Water.SteamTurbineStodola ST_IP(
          ...
          pnom=steamIPNomPressure) annotation (Placement(transformation(extent=
                  {{-20,-20},{20,20}}, rotation=0)));
        Water.SteamTurbineStodola ST_LP(
          ...
          pnom=steamLPNomPressure) annotation (Placement(transformation(extent=
      ...
      model ST3L_valve "Steam turbine with three pressure levels, inlet valves"
        ...
        Water.SteamTurbineStodola ST_LP(
          ...
          PRstart=steamLPNomPressure/pcond) annotation (Placement(
      ...
      equation
        ...
        connect(ActuatorsBus.Opening_valveLP, valveLP.theta) annotation (Line(
              points={{200,-140},{62,-140},{62,40},{102,40},{102,24}}, color={
                213,255,170}));
        connect(ST_HP.inlet, valveHP.outlet) annotation (Line(
            points={{-116,16},{-128,16},{-128,16}},
            thickness=0.5,
            color={0,0,255}));
        connect(ST_HP.shaft_a, Shaft_a) annotation (Line(
      ...
      equation
        ...
        connect(ActuatorsBus.Opening_byPassHP, byPassHP.theta) annotation (Line(
              points={{200,-140},{-180,-140},{-180,30},{-140,30},{-140,60},{-120,
        ...
        connect(SensorsBus.p_STLP_in, p_ST_LP.p) annotation (Line(points={{200,
                -80},{-60,-80},{-60,160},{134,160},{134,90},{108,90}}, color={
                255,170,213}));
      ...
      model ST_2LHU
        ...
        Water.ValveVap valveLP(
          ...
          redeclare package Medium = FluidMedium,
          Cv=valveLP_Cv,
          wnom=steamHPNomFlowRate) annotation (Placement(transformation(extent=
                  {{60,6},{80,26}}, rotation=0)));
        Water.ValveVap valveHP(
          CvData=ThermoPower.Choices.Valve.CvTypes.Cv,
          Cv=valveHP_Cv,
          pnom=steamHPNomPressure,
        ...
        Water.ValveVap byPassHP(
          ...
          CheckValve=true,
          Cv=bypassHP_Cv,
          dpnom=steamHPNomPressure - steamLPNomPressure) annotation (Placement(
      ...
      model ST_2LRhHU
        ...
        Water.ValveVap byPassHP(
          ...
          Cv=bypassHP_Cv,
          dpnom=steamHPNomPressure - steamLPNomPressure) annotation (Placement(
              transformation(extent={{-140,40},{-120,60}}, rotation=0)));
        Water.ValveVap byPassLP(
          redeclare package Medium = FluidMedium,
          CvData=ThermoPower.Choices.Valve.CvTypes.Cv,
          pnom=steamLPNomPressure,
      ...
      equation
        ...
        connect(totalFeedPump.outlet, WaterOut) annotation (Line(
            ...
            color={0,0,255}));
        connect(ActuatorsBus.nPump_feedLP, totalFeedPump.pumpSpeed_rpm)
          annotation (Line(points={{200,-140},{48,-140},{48,-170.4},{72.48,-170.4}},
              color={213,255,170}));
        connect(controlledCondeser.WaterOut, totalFeedPump.inlet) annotation (
            Line(
      ...
      equation
        ...
        connect(steamTurbines.HPT_In, From_SH_HP) annotation (Line(
            ...
            color={0,0,255}));
        connect(totalFeedPump.outlet, WaterOut) annotation (Line(
            points={{104,-180},{160,-180},{160,200}},
            thickness=0.5,
            color={0,0,255}));
        connect(ActuatorsBus.nPump_feedLP, totalFeedPump.pumpSpeed_rpm)
          annotation (Line(points={{200,-140},{52,-140},{52,-170.4},{76.48,-170.4}},
              color={213,255,170}));
        connect(controlledCondeser.WaterOut, totalFeedPump.inlet) annotation (
            Line(
    ...
    package Tests "Test cases"
      ...
      public
        ...
        Water.SteamTurbineStodola steamTurbineStodola(
          ...
          Kt=0.0032078,
          PRstart=130/30,
          pnom=13000000) annotation (Placement(transformation(extent={{-38,-40},
                  {22,20}},rotation=0)));
      equation
        connect(sourceP.flange, valveHP.inlet) annotation (Line(
            points={{-60,70},{-32,70},{-32,60}},
            thickness=0.5,
            color={0,0,255}));
        connect(com_valveHP.y, valveHP.theta)
          annotation (Line(points={{-15,50},{-24,50}}, color={0,0,127}));
        connect(steamTurbineStodola.shaft_b, constantSpeed.flange) annotation (
            Line(
      ...
      public
        ...
        Water.SteamTurbineStodola steamTurbineStodola(
          ...
          pnom=2700000) annotation (Placement(transformation(extent={{-42,-40},
                  {18,20}}, rotation=0)));
      equation
        connect(sourceP.flange, valveIP.inlet) annotation (Line(
            points={{-60,70},{-36,70},{-36,60}},
            thickness=0.5,
            color={0,0,255}));
      ...
      equation
        ...
        connect(com_valveHP.y, valveLP.theta)
          annotation (Line(points={{-17,50},{-26,50}}, color={0,0,127}));
        connect(sinkP.flange, steamTurbineStodola.outlet) annotation (Line(
            points={{30,70},{14,70},{14,14}},
            thickness=0.5,
            color={0,0,255}));
      ...
      public
        Modelica.Blocks.Sources.Ramp rif_velocity(
          ...
          offset=314.16/2,
          duration=50,
          startTime=10) annotation (Placement(transformation(extent={{100,-50},
                  {80,-30}}, rotation=0)));
      ...
      public
        Modelica.Blocks.Sources.Ramp com_valveHP1(
          ...
          height=0.2,
          duration=50,
          startTime=80000) annotation (Placement(transformation(extent={{20,40},
                  {0,60}}, rotation=0)));
      public
        Modelica.Blocks.Sources.Ramp rif_velocity1(
          ...
          offset=0,
          duration=50,
          startTime=80) annotation (Placement(transformation(extent={{100,-90},
                  {80,-70}}, rotation=0)));
        inner System system
          annotation (Placement(transformation(extent={{80,80},{100,100}})));
      equation
        connect(sinkP.flange, steamTurbineVarEta.outlet) annotation (Line(
            points={{10,20},{-4,20},{-4,-36}},
            thickness=0.5,
            color={0,0,255}));
        ...
        connect(com_valveHP.y, add.u2) annotation (Line(points={{-1,80},{-14,80},
                {-14,68},{-20.8,68},{-20.8,67.6}}, color={0,0,127}));
        ...
        connect(add1.y, constantSpeed.w_fixed) annotation (Line(points={{47.2,-54},
                {46,-54},{40,-54}}, color={0,0,127}));
      ...
      model TestCondenserControl
        ...
        Water.SourceMassFlow
          ...
          w0=89.8,
          h=2.3854e6,
          p0=5389.2) annotation (Placement(transformation(extent={{-76,50},{-56,
                  70}}, rotation=0)));
        Modelica.Blocks.Sources.Ramp const(
          offset=0.85,
          duration=500,
          startTime=8000,
          height=0.1) annotation (Placement(transformation(extent={{-60,-66},{-48,
                  -54}}, rotation=0)));
      ...
      equation
        ...
        connect(pID.CS, sourceTap.in_w0) annotation (Line(points={{2,-70},{20,-70},
                {20,-20},{-70,-20},{-70,20},{-54,20},{-54,10}}, color={0,0,127}));
        connect(pID.PV, condenserIdeal_tap.ratio_Vv_Vtot) annotation (Line(
      ...
      equation
        connect(constantSpeed.flange, sTG_3LRh.Shaft_b) annotation (Line(
            ...
            thickness=0.5));
        connect(com_valveHP.y, actuators.Opening_valveHP) annotation (Line(
              points={{79,40},{70,40},{70,-74}}, color={0,0,127}));
        connect(com_valveIP.y, actuators.Opening_valveIP)
          annotation (Line(points={{79,0},{70,0},{70,-74}}, color={0,0,127}));
        connect(com_valveLP.y, actuators.Opening_valveLP) annotation (Line(
              points={{79,-40},{70,-40},{70,-74}}, color={0,0,127}));
  ...
  package ElectricGeneratorGroup
    ...
    package Components "Xomponent definitions"
      model PowerSensor "Measures power flow through the component"
        Electrical.PowerConnection port_a annotation (Placement(transformation(
                extent={{-110,-10},{-90,10}}, rotation=0)));
        Electrical.PowerConnection port_b annotation (Placement(transformation(
      ...
      equation
        ...
        annotation (Diagram(graphics), Icon(graphics={Ellipse(
                ...
                color={0,0,0}),Line(points={{22.9,32.8},{40.2,57.3}}, color={0,
                0,0}),Line(points={{-22.9,32.8},{-40.2,57.3}}, color={0,0,0}),
                Line(points={{37.6,13.7},{65.8,23.9}}, color={0,0,0}),Line(
                points={{-37.6,13.7},{-65.8,23.9}}, color={0,0,0}),Line(points=
                {{0,0},{9.02,28.6}}, color={0,0,0}),Polygon(
                      ...
                      extent={{-29,-11},{30,-70}},
                      lineColor={0,0,0},
                      textString="W"),Line(points={{-70,0},{-90,0}}, color={0,0,
                0}),Line(points={{100,0},{70,0}}, color={0,0,0}),Text(extent={{
                -148,88},{152,128}}, textString="%name"),Line(points={{0,-70},{
                0,-84}}, color={0,0,0})}));
      end PowerSensor;

      model FrequencySensor "Measures the frequency at the connector"
        Electrical.PowerConnection port annotation (Placement(transformation(
                extent={{-110,-10},{-90,10}}, rotation=0)));
      ...
      equation
        ...
        annotation (Diagram(graphics), Icon(graphics={Ellipse(
                ...
                {{0,0},{9.02,28.6}}, color={0,0,0}),Polygon(
                      ...
                      extent={{-29,-11},{30,-70}},
                      lineColor={0,0,0},
                      textString="f"),Line(points={{-70,0},{-90,0}}, color={0,0,
                0}),Line(points={{100,0},{70,0}}, color={0,0,0}),Text(extent={{
                -148,88},{152,128}}, textString="%name")}));
      end FrequencySensor;
      ...
      model Grid_2in "Ideal grid with finite droop and two inlet"
        ...
        Electrical.PowerConnection connection_A annotation (Placement(
              transformation(extent={{-100,26},{-72,54}}, rotation=0)));
        Electrical.PowerConnection connection_B annotation (Placement(
              transformation(extent={{-100,-54},{-72,-26}}, rotation=0)));
      equation
        ...
        annotation (Diagram(graphics), Icon(graphics={Line(points={{18,-16},{2,
                -38}}, color={0,0,0}),Line(points={{-72,-40},{-36,-20}}, color=
                {0,0,0}),Ellipse(
                      extent={{100,-68},{-40,68}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{-40,0},{-6,0},
                {24,36},{54,50}}, color={0,0,0}),Line(points={{24,36},{36,-6}},
                color={0,0,0}),Line(points={{-6,0},{16,-14},{40,-52}}, color={0,
                0,0}),Line(points={{18,-14},{34,-6},{70,-22}}, color={0,0,0}),
                Line(points={{68,18},{36,-4},{36,-4}}, color={0,0,0}),Ellipse(
                      extent={{-8,2},{-2,-4}},
                      lineColor={0,0,0},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Ellipse(
                      ...
                      lineColor={0,0,0},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{-72,40},{-36,
                20}}, color={0,0,0})}));
      end Grid_2in;
      ...
      model Grid_3in "Ideal grid with finite droop and three inlet"
        ...
        Electrical.PowerConnection connection_C annotation (Placement(
      ...
      equation
        ...
        annotation (Diagram(graphics), Icon(graphics={Line(points={{18,-16},{2,
                -38}}, color={0,0,0}),Line(points={{-72,-80},{-20,-48}}, color=
                {0,0,0}),Ellipse(
                      extent={{100,-68},{-40,68}},
                      lineColor={0,0,0},
                      lineThickness=0.5,
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{-72,0},{-6,0},
                {24,36},{54,50}}, color={0,0,0}),Line(points={{24,36},{36,-6}},
                color={0,0,0}),Line(points={{-6,0},{16,-14},{40,-52}}, color={0,
                0,0}),Line(points={{18,-14},{34,-6},{70,-22}}, color={0,0,0}),
                Line(points={{68,18},{36,-4},{36,-4}}, color={0,0,0}),Ellipse(
                      ...
                      lineColor={0,0,0},
                      fillColor={255,255,255},
                      fillPattern=FillPattern.Solid),Line(points={{-72,80},{-26,
                40}}, color={0,0,0})}));
      end Grid_3in;
      ...
      package OldElementsSwingEquation
        model Generator_SE
          ...
          SI.Conversions.NonUnits.SI.AngularVelocity_rpm n "Rotational speed";
        ...
        equation
          ...
          omega = der(shaft.phi);
          Pm = omega*shaft.tau;
          n = Modelica.Units.SI.Conversions.to_rpm(omega)
    ...
    package Examples "Example implementations"
      model SingleShaft_static
        ...
        Components.FrequencySensor frequencySensor annotation (Placement(
        ...
        Modelica.Mechanics.Rotational.Components.Inertia inertia(
          ...
          phi(fixed=if ((Options.steadyState) == 3 or (Options.steadyState) ==
                4 or (Options.steadyState) == 7 or (Options.steadyState) == 9)
          ...
          w(fixed=if ((Options.steadyState) == 2 or (Options.steadyState) == 3
                ...
                omega_nom)) annotation (Placement(transformation(extent={{-120,
      ...
      equation
        ...
        connect(SensorsBus.power, powerSensor.W) annotation (Line(points={{200,
                -80},{100,-80},{100,-40},{20,-40},{20,-7.52}}, color={255,170,
                213}));
      ...
      model DoubleShaft_static
        ...
        Electrical.Generator generator_A(eta=eta_A, initOpt=if SSInit then
              ThermoPower.Choices.Init.Options.steadyState else ThermoPower.Choices.Init.Options.noInit)
          annotation (Placement(transformation(extent={{-80,70},{-20,130}},
                rotation=0)));
        Modelica.Mechanics.Rotational.Components.Inertia inertia_A(J=J_shaft_A,
            w(start=omega_nom_A)) annotation (Placement(transformation(extent={
                  {-120,90},{-100,110}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Damper damper_A(d=d_shaft_A)
          annotation (Placement(transformation(extent={{-120,10},{-100,30}},
                rotation=0)));
        Modelica.Mechanics.Rotational.Components.Fixed fixed annotation (
            Placement(transformation(extent={{-50,-46},{-30,-26}}, rotation=0)));
        Electrical.Breaker breaker_A annotation (Placement(transformation(
                extent={{60,120},{100,80}}, rotation=0)));
        Electrical.Generator generator_B(eta=eta_B, initOpt=if SSInit then
              ThermoPower.Choices.Init.Options.steadyState else ThermoPower.Choices.Init.Options.noInit)
          annotation (Placement(transformation(extent={{-80,-130},{-20,-70}},
                rotation=0)));
        Modelica.Mechanics.Rotational.Components.Inertia inertia_B(J=J_shaft_B,
            w(start=omega_nom_B)) annotation (Placement(transformation(extent={
                  {-120,-110},{-100,-90}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Damper damper_B(d=d_shaft_B)
          annotation (Placement(transformation(extent={{-120,-30},{-100,-10}},
                rotation=0)));
        Electrical.Breaker breaker_B annotation (Placement(transformation(
                extent={{60,-120},{100,-80}}, rotation=0)));
        Components.PowerSensor powerSensor_A annotation (Placement(
              transformation(extent={{10,90},{30,110}}, rotation=0)));
        Components.FrequencySensor frequencySensor_A annotation (Placement(
              transformation(extent={{10,160},{30,180}}, rotation=0)));
        Components.PowerSensor powerSensor_B annotation (Placement(
              transformation(extent={{10,-110},{30,-90}}, rotation=0)));
        Components.FrequencySensor frequencySensor_B annotation (Placement(
              transformation(extent={{8,-170},{28,-150}}, rotation=0)));
        ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.Grid_2in grid(
            Pn=Pn, fn=fn) annotation (Placement(transformation(extent={{140,0},
                  {180,40}}, rotation=0)));
      equation
        ...
        connect(SensorsBus.frequency_shaftA, frequencySensor_A.f) annotation (
            Line(points={{200,-80},{140,-80},{140,-140},{40,-140},{40,170},{
                30.2,170}}, color={255,170,213}));
        connect(SensorsBus.frequency_shaftB, frequencySensor_B.f) annotation (
            Line(points={{200,-80},{140,-80},{140,-140},{60,-140},{60,-160},{
      ...
      model TripleShaft_static
        ...
        Electrical.Generator generator_A(eta=eta_A, initOpt=if SSInit then
              ThermoPower.Choices.Init.Options.steadyState else ThermoPower.Choices.Init.Options.noInit)
          annotation (Placement(transformation(extent={{-80,90},{-20,150}},
                rotation=0)));
        Components.PowerSensor powerSensor_A annotation (Placement(
              transformation(extent={{20,110},{40,130}}, rotation=0)));
        Components.FrequencySensor frequencySensor_A annotation (Placement(
              transformation(extent={{20,150},{40,170}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Inertia inertia_A(J=J_shaft_A,
            w(start=omega_nom_A)) annotation (Placement(transformation(extent={
                  {-140,110},{-120,130}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Damper damper_A(d=d_shaft_A)
          annotation (Placement(transformation(extent={{-140,70},{-120,90}},
                rotation=0)));
        Electrical.Breaker breaker_A annotation (Placement(transformation(
                extent={{60,100},{100,140}}, rotation=0)));
        Electrical.Generator generator_B(eta=eta_B, initOpt=if SSInit then
              ThermoPower.Choices.Init.Options.steadyState else ThermoPower.Choices.Init.Options.noInit)
        ...
        Modelica.Mechanics.Rotational.Components.Inertia inertia_B(J=J_shaft_B,
            w(start=omega_nom_B)) annotation (Placement(transformation(extent={
                  {-140,-10},{-120,10}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Damper damper_B(d=d_shaft_B)
          annotation (Placement(transformation(extent={{-140,-50},{-120,-30}},
                rotation=0)));
        Modelica.Mechanics.Rotational.Components.Fixed fixed annotation (
            Placement(transformation(extent={{-110,-186},{-90,-166}}, rotation=
                  0)));
        Electrical.Breaker breaker_B annotation (Placement(transformation(
                extent={{60,-20},{100,20}}, rotation=0)));
        Electrical.Generator generator_C(eta=eta_C, initOpt=if SSInit then
              ThermoPower.Choices.Init.Options.steadyState else ThermoPower.Choices.Init.Options.noInit)
          annotation (Placement(transformation(extent={{-80,-150},{-20,-90}},
                rotation=0)));
        Components.PowerSensor powerSensor_C annotation (Placement(
              transformation(extent={{20,-130},{40,-110}}, rotation=0)));
        Components.FrequencySensor frequencySensor_C annotation (Placement(
              transformation(extent={{20,-90},{40,-70}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Inertia inertia_C(J=J_shaft_C,
            w(start=omega_nom_C)) annotation (Placement(transformation(extent={
                  {-140,-130},{-120,-110}}, rotation=0)));
        Modelica.Mechanics.Rotational.Components.Damper damper_C(d=d_shaft_C)
          annotation (Placement(transformation(extent={{-140,-170},{-120,-150}},
                rotation=0)));
        Electrical.Breaker breaker_C annotation (Placement(transformation(
                extent={{60,-140},{100,-100}}, rotation=0)));
        Components.Grid_3in grid_3in(Pn=Pn, fn=fn) annotation (Placement(
              transformation(extent={{140,-20},{180,20}}, rotation=0)));
      equation
        ...
        connect(SensorsBus.frequency_shaftC, frequencySensor_C.f) annotation (
            Line(points={{200,-80},{160,-80},{160,-60},{54,-60},{54,-80},{40.2,
                -80}}, color={255,170,213}));
        connect(SensorsBus.power_shaftB, powerSensor_B.W) annotation (Line(
              points={{200,-80},{160,-80},{160,-60},{54,-60},{54,-20},{30,-20},
                {30,-9.4}}, color={255,170,213}));
        connect(SensorsBus.frequency_shaftB, frequencySensor_B.f) annotation (
            Line(points={{200,-80},{160,-80},{160,-60},{54,-60},{54,40},{40.2,
                40}}, color={255,170,213}));
        connect(SensorsBus.power_shaftA, powerSensor_A.W) annotation (Line(
              points={{200,-80},{160,-80},{160,-60},{54,-60},{54,100},{30,100},
                {30,110.6}}, color={255,170,213}));
        connect(SensorsBus.frequency_shaftA, frequencySensor_A.f) annotation (
            Line(points={{200,-80},{160,-80},{160,-60},{54,-60},{54,160},{40.2,
      ...
      model GeneratorGroup
        ...
        parameter SI.Angle delta_start=0 "Loaded angle start value";

        ThermoPower.Electrical.PowerSensor powerSensor annotation (Placement(
              transformation(extent={{20,-10},{40,10}}, rotation=0)));
        ...
        Modelica.Mechanics.Rotational.Components.Damper damper(d=d_shaft, phi_rel(
          ...
          annotation (Placement(transformation(extent={{-100,-60},{-80,-40}},
                rotation=0)));
        Modelica.Mechanics.Rotational.Components.Fixed fixed annotation (
            Placement(transformation(extent={{-50,-86},{-30,-66}}, rotation=0)));
      equation
        connect(SensorsBus.power, powerSensor.W) annotation (Line(points={{200,
                -80},{30,-80},{30,-9.4}}, color={255,170,213}));
        connect(SensorsBus.frequency, frequencySensor.f) annotation (Line(
      ...
      package OldSwingEquation
        ...
        equation
          connect(SensorsBus.power, powerSensor.W) annotation (Line(points={{200,-80},
                  {10,-80},{10,-9.4}},            color={255,170,213}));
          connect(SensorsBus.frequency, frequencySensor.f) annotation (Line(
                points={{200,-80},{34,-80},{34,30},{20.2,30}},   color={255,170,
                  213}));
        ...
        model DoubleShaft_SE
          ...
          Components.FrequencySensor frequencySensor_A annotation (Placement(
                transformation(extent={{20,130},{40,150}}, rotation=0)));
          Components.PowerSensor powerSensor_B annotation (Placement(
          ...
          ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.Grid_2in
            grid(Pn=Pn, fn=fn) annotation (Placement(transformation(extent={{
          ...
          Components.OldElementsSwingEquation.Generator_SE generator_SE_A(
            ...
            omega_nom=omega_nom_A) annotation (Placement(transformation(extent=
                    {{-100,70},{-40,130}}, rotation=0)));
          ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE
            generator_SE_B(
            eta=eta_B,
            Pmax=Pmax_B,
            ...
            omega_nom=omega_nom_B) annotation (Placement(transformation(extent=
                    {{-100,-130},{-40,-70}}, rotation=0)));
        ...
        model TripleShaft_SE
          ...
          Components.FrequencySensor frequencySensor_A annotation (Placement(
                transformation(extent={{10,150},{30,170}}, rotation=0)));
          Components.PowerSensor powerSensor_B annotation (Placement(
          ...
          ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE
            ...
            omega_nom=omega_nom_C) annotation (Placement(transformation(extent=
                    {{-120,-150},{-60,-90}}, rotation=0)));
        equation
          connect(SensorsBus.power_shaftC, powerSensor_C.W) annotation (Line(
          ...
          connect(grid_3in.connection_B, powerSensor_B.port_b) annotation (Line(
              points={{142.8,3.55271e-016},{51.7,3.55271e-016},{51.7,-0.2},{30,
                  -0.2}},
              pattern=LinePattern.None,
              thickness=0.5));
    ...
    package Tests "Test cases"
      ...
      public
        Modelica.Blocks.Sources.Ramp com_valveHP_a(
          ...
          startTime=5,
          height=+0.7,
          duration=3) annotation (Placement(transformation(extent={{0,76},{-12,
                  88}}, rotation=0)));
      public
        Modelica.Blocks.Sources.Ramp com_valveHP_b(
          ...
          duration=5,
          height=-0.8,
          startTime=15) annotation (Placement(transformation(extent={{0,54},{-12,
                  66}}, rotation=0)));
        Modelica.Blocks.Math.Add add annotation (Placement(transformation(
              origin={-49,69},
              extent={{-7,-7},{7,7}},
        ...
        ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE
          ...
          omega_nom=157.08) annotation (Placement(transformation(extent={{-30,-48},
                  {50,32}}, rotation=0)));
        Electrical.Grid grid(Pn=50e8, droop=0) annotation (Placement(
              transformation(extent={{66,-18},{86,2}}, rotation=0)));
        inner System system
          annotation (Placement(transformation(extent={{80,80},{100,100}})));
      equation
        connect(sinkP.flange, steamTurbineStodola.outlet) annotation (Line(
        ...
        connect(com_valveHP_b.y, add.u1) annotation (Line(points={{-12.6,60},{-30,
                60},{-30,64},{-40.6,64},{-40.6,64.8}}, color={0,0,127}));
        connect(com_valveHP_a.y, add.u2) annotation (Line(points={{-12.6,82},{-30,
                82},{-30,74},{-40.6,74},{-40.6,73.2}}, color={0,0,127}));
      ...
      public
        Modelica.Blocks.Sources.Ramp com_valveHP_a(
          ...
          offset=0.2,
          duration=5,
          startTime=1000) annotation (Placement(transformation(extent={{0,76},{
                  -12,88}}, rotation=0)));
      public
        Modelica.Blocks.Sources.Ramp com_valveHP_b(
          height=-0.9,
          offset=0,
          duration=5,
          startTime=2000) annotation (Placement(transformation(extent={{0,54},{
                  -12,66}}, rotation=0)));
        Modelica.Blocks.Math.Add add annotation (Placement(transformation(
              origin={-49,69},
              extent={{-7,-7},{7,7}},
        ...
        ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE_com
          ...
          delta_start=0.77,
          Pmax=20e6,
          r=0.2) annotation (Placement(transformation(extent={{-30,-48},{50,32}},
                rotation=0)));
        Electrical.Grid grid(Pn=50e8, droop=0) annotation (Placement(
              transformation(extent={{66,-18},{86,2}}, rotation=0)));
        inner System system
      ...
      equation
        ...
        connect(grid.connection, generator_SE.powerConnection) annotation (Line(
            ...
            pattern=LinePattern.None,
            thickness=0.5));
        annotation (Diagram(graphics), experiment(StopTime=3000,
      ...
      public
        ...
        ThermoPower.PowerPlants.ElectricGeneratorGroup.Components.OldElementsSwingEquation.Generator_SE_Breaker
          ...
          omega_start=157.08,
          r=0.2,
          delta_start=0.5073) annotation (Placement(transformation(extent={{-30,
                  -48},{50,32}}, rotation=0)));
        Electrical.Grid grid(Pn=50e8, droop=0) annotation (Placement(
              transformation(extent={{66,-18},{86,2}}, rotation=0)));
      public
      ...
      equation
        ...
        connect(sinkP.flange, steamTurbineStodola.outlet) annotation (Line(
            ...
            thickness=0.5,
            color={0,0,255}));
        connect(sensors, singleShaft.SensorsBus) annotation (Line(points={{72,
                50},{90,50},{90,-16},{80,-16}}, color={255,170,213}));
        connect(actuators, singleShaft.ActuatorsBus) annotation (Line(points={{
                74,-50},{90,-50},{90,-28},{80,-28}}, color={213,255,170}));
      ...
      equation
        ...
        connect(Turbine1.shaft_b, doubleShaft.shaft_A) annotation (Line(
            ...
            color={0,0,0},
            thickness=0.5));
        connect(actuators, doubleShaft.ActuatorsBus) annotation (Line(points={{
                74,-30},{92,-30},{92,-11},{80,-11}}, color={213,255,170}));
        connect(booleanConstant.y, actuators.breakerClosed_shaftA) annotation (
            Line(points={{41,-60},{60,-60},{60,-30},{74,-30}}, color={255,0,255}));
        connect(booleanConstant.y, actuators.breakerClosed_shaftB) annotation (
            Line(points={{41,-60},{52,-60},{52,-30},{74,-30}}, color={255,0,255}));
      ...
      equation
        ...
        connect(actuators, tripleShaft.ActuatorsBus) annotation (Line(points={{
                74,-50},{92,-50},{92,-28},{80,-28}}, color={213,255,170}));
        connect(booleanConstant.y, actuators.breakerClosed_shaftA) annotation (
            Line(points={{41,-88},{60,-88},{60,-50},{74,-50}}, color={255,0,255}));
        connect(booleanConstant.y, actuators.breakerClosed_shaftB) annotation (
            Line(points={{41,-88},{54,-88},{54,-50},{74,-50}}, color={255,0,255}));
        connect(booleanConstant.y, actuators.breakerClosed_shaftC) annotation (
            Line(points={{41,-88},{48,-88},{48,-50},{74,-50}}, color={255,0,255}));
        connect(sourceW1.flange, Turbine1.inlet) annotation (Line(
...
<li><i>15 Apr 2008</i>
  ...
  package Control "Models of the common control elements"
    ...
    model LevelSetPoint
      ...
      parameter Length y1;
      parameter Length y2;
      Modelica.Blocks.Interfaces.RealInput drumPressure annotation (Placement(
    ...
    equation
      levelSetPoint = noEvent(if drumPressure < p1 then y1 else if drumPressure
         > p2 then y2 else y1 + (y2 - y1)/(p2 - p1)*(drumPressure - p1));
      annotation (Diagram(graphics), Icon(graphics={Rectangle(
                  extent={{-100,100},{100,-100}},
                  lineColor={0,0,0},
                  fillColor={240,240,240},
  ...
  package Simulators
    ...
    public
      Modelica.Blocks.Sources.Ramp valveHP_com(
        height=0,
        offset=1,
        duration=2) annotation (Placement(transformation(extent={{160,60},{140,
                80}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveIP_com(
        height=0,
        offset=1,
        duration=2) annotation (Placement(transformation(extent={{160,20},{140,
                40}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveLP_com(
        ...
        duration=2) annotation (Placement(transformation(extent={{160,-20},{140,
                0}}, rotation=0)));
    protected
      Buses.Actuators actuators1 annotation (Placement(transformation(extent={{
    ...
    equation
      ...
      connect(sTG_3LRh.SensorsBus, singleShaft.SensorsBus) annotation (Line(
            points={{-20,-150},{20,-150},{20,-190},{160,-190},{160,-150},{140,-150}},
            color={255,170,213}));
      connect(singleShaft.ActuatorsBus, sTG_3LRh.ActuatorsBus) annotation (Line(
            points={{140,-165},{152,-165},{152,-184},{14,-184},{14,-165},{-20,-165}},
            color={213,255,170}));
      annotation (
...
<li><i>15 Apr 2008</i>
    ...
    public
      Modelica.Blocks.Sources.Ramp valveHP_com(
        ...
        height=-0.5,
        duration=100,
        startTime=50) annotation (Placement(transformation(extent={{180,60},{
                160,80}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveIP_com(height=0, offset=1) annotation (
          Placement(transformation(extent={{180,20},{160,40}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveLP_com(height=0, offset=1) annotation (
          Placement(transformation(extent={{180,-20},{160,0}}, rotation=0)));
    protected
      Buses.Actuators actuators annotation (Placement(transformation(extent={{
    ...
    public
      ...
      SteamTurbineGroup.Examples.STG_3LRh_valve_cc sTG_3LRh(
        ...
        totalFeedPump(nominalOutletPressure=604700)) annotation (Placement(
            transformation(extent={{-120,-180},{-20,-80}}, rotation=0)));
    public
      HRSG.Control.levelsControl levelsControl(
        CSmin_levelHP=30,
        CSmax_levelHP=96,
...
<li><i>15 Apr 2008</i>
    ...
    public
      Modelica.Blocks.Sources.BooleanConstant booleanConstant(k=true)
        annotation (Placement(transformation(extent={{-180,40},{-160,60}},
              rotation=0)));
    public
      Modelica.Blocks.Sources.Ramp valveHP_com(height=0, offset=1) annotation (
          Placement(transformation(extent={{-180,160},{-160,180}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveIP_com(height=0, offset=1) annotation (
          Placement(transformation(extent={{-180,120},{-160,140}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveLP_com(height=0, offset=1) annotation (
          Placement(transformation(extent={{-180,80},{-160,100}}, rotation=0)));
    protected
      Buses.Actuators actuators annotation (Placement(transformation(extent={{-70,
    ...
    equation
      ...
      connect(gasTurbine.GTLoad, ramp.y)
        annotation (Line(points={{-140,-20},{-159,-20}}, color={0,0,127}));
...
<li><i>15 Apr 2008</i>
    ...
    public
      Modelica.Blocks.Sources.Ramp valveHP_com(
        height=0,
        offset=1,
        duration=2) annotation (Placement(transformation(extent={{180,60},{160,
                80}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveIP_com(
        height=0,
        offset=1,
        duration=2) annotation (Placement(transformation(extent={{180,20},{160,
                40}}, rotation=0)));
      Modelica.Blocks.Sources.Ramp valveLP_com(
        height=0,
        offset=1,
    ...
    equation
      connect(ramp.y, sourceGas.in_w0) annotation (Line(points={{-169,110},{-156,
              110},{-156,65}}, color={0,0,127}));
      connect(sourceGas.flange, hRSG.GasIn) annotation (Line(
      ...
      connect(sTG_3LRh.SensorsBus, singleShaft.SensorsBus) annotation (Line(
            ...
            color={255,170,213}));
      connect(singleShaft.ActuatorsBus, sTG_3LRh.ActuatorsBus) annotation (Line(
            points={{160,-165},{172,-165},{172,-184},{34,-184},{34,-165},{0,-165}},
            color={213,255,170}));
      connect(sTG_3LRh.WaterOut, hRSG.WaterIn) annotation (Line(
