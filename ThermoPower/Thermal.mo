...
<p>To use the model, set the material temperature to the desired value by a suitable equation.
    ...
    package Functions
      ...
      function CtoKTable
        extends Modelica.Units.SI.Conversions.ConversionIcon;
      ...
      algorithm
        ...
        for i in 1:size(table_degC, 1) loop
          table_degK[i, 1] := Modelica.Units.SI.Conversions.from_degC(table_degC[
            i, 1]);
        end for;
      end CtoKTable;
   ...
   only to be used in Material.MaterialTable"
    ...
    package Test "Test cases"
      ...
      equation
        T_C = 21 + 500*time;
        T = Modelica.Units.SI.Conversions.from_degC(T_C);
        Material.T = T;
